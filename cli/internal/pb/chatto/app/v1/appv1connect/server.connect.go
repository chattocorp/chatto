...
const (
	...
	ServerServiceName = "chatto.app.v1.ServerService"
)
...
const (
	...
	ServerServiceGetServerProcedure = "/chatto.app.v1.ServerService/GetServer"
)

// ServerServiceClient is a client for the chatto.app.v1.ServerService service.
...
// NewServerServiceClient constructs a client for the chatto.app.v1.ServerService service. By
...
func NewServerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ServerServiceClient {
	...
	serverServiceMethods := v1.File_chatto_app_v1_server_proto.Services().ByName("ServerService").Methods()
...
// GetServer calls chatto.app.v1.ServerService.GetServer.
...
// ServerServiceHandler is an implementation of the chatto.app.v1.ServerService service.
...
func NewServerServiceHandler(svc ServerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.ServerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServerServiceHandler) GetServer(context.Context, *connect.Request[v1.GetServerRequest]) (*connect.Response[v1.GetServerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerService.GetServer is not implemented"))
}
