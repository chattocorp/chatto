...
Select the App Preferences gear in the Application Header. Open **Composer → Message editor**, and select an option:
...
In App Preferences, open **Composer → Send messages with**, and select an option:
