...
| Field | Type | Description |
| --- | --- | --- |
| `asset` | [`RoomTimelineAttachment`](/reference/connectrpc-api/types/#chatto-api-v1-RoomTimelineAttachment) | Asset metadata and signed URLs. |
...
| Field | Type | Description |
| --- | --- | --- |
| `assets` | repeated [`RoomTimelineAttachment`](/reference/connectrpc-api/types/#chatto-api-v1-RoomTimelineAttachment) | Assets in first-seen request order. |
