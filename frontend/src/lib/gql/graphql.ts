...
export type Mutation = {
  ...
  /**
   * Mark a room as auto-join (or unset). Auto-join rooms grant implicit
   * membership to every server member with `room.join` resolved at the
   * room, and can't be left. Requires rooms.manage.
   */
...
export type Room = {
  ...
  /**
   * Auto-join rooms grant implicit membership to every server member for
   * whom `room.join` resolves to allow at the room (no per-user join
   * records). They can't be left (members can still mute) and always
   * appear in their sidebar. Explicit `room_membership` records still
   * win: once a user has joined, that record persists across auto-join
   * flips and permission changes.
   */
  ...
  /** Whether the current user can use reply attribution (in rooms or threads) in this room. */
...
/**
 * Event: A room was marked as auto-join. Server members with `room.join`
 * resolved at the room gain implicit membership immediately.
 */
export type RoomBecameAutoJoinEvent = {
  __typename?: 'RoomBecameAutoJoinEvent';
  /** The ID of the room that became auto-join. */
  roomId: Scalars['ID']['output'];
};

/**
 * Event: A room is no longer auto-join. Implicit members lose their
 * membership; explicit members are unaffected.
 */
export type RoomBecameRegularEvent = {
  __typename?: 'RoomBecameRegularEvent';
  /** The ID of the room that is no longer auto-join. */
  roomId: Scalars['ID']['output'];
};
...
export type RoomEventType = CallParticipantJoinedEvent | CallParticipantLeftEvent | MessageDeletedEvent | MessagePostedEvent | MessageUpdatedEvent | PresenceChangedEvent | ReactionAddedEvent | ReactionRemovedEvent | RoomArchivedEvent | RoomBecameAutoJoinEvent | RoomBecameRegularEvent | RoomCreatedEvent | RoomDeletedEvent | RoomUnarchivedEvent | RoomUpdatedEvent | ServerMemberDeletedEvent | UserJoinedRoomEvent | UserLeftRoomEvent | UserTypingEvent | VideoProcessingCompletedEvent;
...
export type MyServerEventsSubscription = { __typename?: 'Subscription', myEvents: { __typename?: 'ServerEvent', id: string, createdAt: any, actorId: string, actor?: (
      ...
      | { __typename: 'RoomBecameAutoJoinEvent', roomId: string }
      | { __typename: 'RoomBecameRegularEvent', roomId: string }
...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, autoJoin: boolean, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanReply: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, members: Array<{ __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, presenceStatus: PresenceStatus }> } | null, server: { __typename?: 'Server', viewerCanManageRooms: boolean, config: { __typename?: 'ServerConfig', serverName: string } } };
...
export type UserPermissionsHeaderQueryVariables = Exact<{
  userId: Scalars['ID']['input'];
}>;


export type UserPermissionsHeaderQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, login: string, displayName: string } | null };
...
export type RolePermissionsHeaderQueryVariables = Exact<{
  name: Scalars['String']['input'];
}>;


export type RolePermissionsHeaderQuery = { __typename?: 'Query', server: { __typename?: 'Server', role?: { __typename?: 'Role', name: string, displayName: string } | null } };
...
export type AdminRoomGroupsQuery = { __typename?: 'Query', server: { __typename?: 'Server', rooms: Array<{ __typename?: 'Room', id: string, name: string, description?: string | null, archived: boolean, autoJoin: boolean }>, roomGroups: Array<{ __typename?: 'RoomGroup', id: string, name: string, rooms: Array<{ __typename?: 'Room', id: string }> }> } };
...
export const UserPermissionsHeaderDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UserPermissionsHeader"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]} as unknown as DocumentNode<UserPermissionsHeaderQuery, UserPermissionsHeaderQueryVariables>;
...
export const RolePermissionsHeaderDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RolePermissionsHeader"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"server"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"role"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}}]}}]}}]}}]} as unknown as DocumentNode<RolePermissionsHeaderQuery, RolePermissionsHeaderQueryVariables>;
