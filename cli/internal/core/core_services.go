...
func assembleCore(
	...
	return &ChattoCore{
		...
		RoomDirectory:            projections.roomDirectory,
		RoomDirectoryProjector:   projections.roomDirectoryProjector,
		RoomMembership:           projections.roomDirectory.Membership,
		RoomBans:                 projections.roomDirectory.Bans,
		RoomCatalog:              projections.roomDirectory.Catalog,
		RoomGroupLayout:          projections.roomGroupLayout,
		RoomGroupLayoutProjector: projections.roomGroupLayoutProjector,
		...
		ThreadsProjector:         projections.threadsProjector,
		Reactions:                projections.reactions,
		ReactionsProjector:       projections.reactionsProjector,
		Users:                    projections.users,
		UsersProjector:           projections.usersProjector,
		UserAuthProjector:        projections.userAuthProjector,
		ContentKeys:              projections.contentKeys,
		ContentKeysProjector:     projections.contentKeysProjector,
		RBAC:                     projections.rbac,
		RBACProjector:            projections.rbacProjector,
		Mentionables:             projections.mentionables,
		MentionablesProjector:    projections.mentionablesProjector,
