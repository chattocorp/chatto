...
const (
	...
	NotificationServiceName = "chatto.app.v1.NotificationService"
)
...
const (
	...
	NotificationServiceListNotificationsProcedure = "/chatto.app.v1.NotificationService/ListNotifications"
	...
	NotificationServiceListRoomNotificationsProcedure = "/chatto.app.v1.NotificationService/ListRoomNotifications"
	...
	NotificationServiceListNotificationCountsProcedure = "/chatto.app.v1.NotificationService/ListNotificationCounts"
	...
	NotificationServiceHasNotificationsProcedure = "/chatto.app.v1.NotificationService/HasNotifications"
	...
	NotificationServiceDismissNotificationProcedure = "/chatto.app.v1.NotificationService/DismissNotification"
	...
	NotificationServiceDismissAllNotificationsProcedure = "/chatto.app.v1.NotificationService/DismissAllNotifications"
)

// NotificationServiceClient is a client for the chatto.app.v1.NotificationService service.
...
// NewNotificationServiceClient constructs a client for the chatto.app.v1.NotificationService
...
func NewNotificationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotificationServiceClient {
	...
	notificationServiceMethods := v1.File_chatto_app_v1_notifications_proto.Services().ByName("NotificationService").Methods()
...
// ListNotifications calls chatto.app.v1.NotificationService.ListNotifications.
...
// ListRoomNotifications calls chatto.app.v1.NotificationService.ListRoomNotifications.
...
// ListNotificationCounts calls chatto.app.v1.NotificationService.ListNotificationCounts.
...
// HasNotifications calls chatto.app.v1.NotificationService.HasNotifications.
...
// DismissNotification calls chatto.app.v1.NotificationService.DismissNotification.
...
// DismissAllNotifications calls chatto.app.v1.NotificationService.DismissAllNotifications.
...
// NotificationServiceHandler is an implementation of the chatto.app.v1.NotificationService service.
...
func NewNotificationServiceHandler(svc NotificationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.NotificationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotificationServiceHandler) ListNotifications(context.Context, *connect.Request[v1.ListNotificationsRequest]) (*connect.Response[v1.ListNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.ListNotifications is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) ListRoomNotifications(context.Context, *connect.Request[v1.ListRoomNotificationsRequest]) (*connect.Response[v1.ListRoomNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.ListRoomNotifications is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) ListNotificationCounts(context.Context, *connect.Request[v1.ListNotificationCountsRequest]) (*connect.Response[v1.ListNotificationCountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.ListNotificationCounts is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) HasNotifications(context.Context, *connect.Request[v1.HasNotificationsRequest]) (*connect.Response[v1.HasNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.HasNotifications is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) DismissNotification(context.Context, *connect.Request[v1.DismissNotificationRequest]) (*connect.Response[v1.DismissNotificationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.DismissNotification is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) DismissAllNotifications(context.Context, *connect.Request[v1.DismissAllNotificationsRequest]) (*connect.Response[v1.DismissAllNotificationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.NotificationService.DismissAllNotifications is not implemented"))
}
