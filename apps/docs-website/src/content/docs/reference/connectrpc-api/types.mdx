...
<a id="chatto-admin-v1-Invitation"></a>
...
| `status` | [`InvitationStatus`](#chatto-admin-v1-InvitationStatus) | No field description provided. |
...
<a id="chatto-admin-v1-InvitationStatus"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `INVITATION_STATUS_UNSPECIFIED` | `0` | No value description provided. |
| `INVITATION_STATUS_ACTIVE` | `1` | No value description provided. |
| `INVITATION_STATUS_EXPIRED` | `2` | No value description provided. |
| `INVITATION_STATUS_EXHAUSTED` | `3` | No value description provided. |
| `INVITATION_STATUS_REVOKED` | `4` | No value description provided. |
