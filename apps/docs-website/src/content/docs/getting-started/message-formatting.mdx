...
Open **App Preferences → Composer → Message editor** from the gear in the Application Header and choose:
...
Open **App Preferences → Composer → Send messages with** from the gear in the Application Header and choose:
