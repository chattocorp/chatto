...
// @generated from file chatto/app/v1/reactions.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.app.v1.AddReactionRequest
 */
export class AddReactionRequest extends Message<AddReactionRequest> {
  ...
  static readonly typeName = "chatto.app.v1.AddReactionRequest";
 ...
 *
 * @generated from message chatto.app.v1.AddReactionResponse
 */
export class AddReactionResponse extends Message<AddReactionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.AddReactionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.RemoveReactionRequest
 */
export class RemoveReactionRequest extends Message<RemoveReactionRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.RemoveReactionRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "message_event_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "emoji", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message chatto.app.v1.RemoveReactionResponse
 */
export class RemoveReactionResponse extends Message<RemoveReactionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.RemoveReactionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
