...
<ReleaseFeatureGrid>
  ...
  <ReleaseFeatureCard title="Advertise friendly Chatto servers">
    Server administrators can maintain a public Neighbor directory. Users and
    clients can discover the advertised server origins without signing in. A
    listing is a recommendation, not a verified or reciprocal relationship.
  </ReleaseFeatureCard>
