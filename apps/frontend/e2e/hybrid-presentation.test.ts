...
test.use({
	launchOptions: { args: ['--blink-settings=availablePointerTypes=6,primaryPointerType=4,availableHoverTypes=2,primaryHoverType=2'] },
	viewport: { width: 1024, height: 800 }
});

test('keeps touch presentation and mouse interaction on a hybrid device', async ({ page, chatPage }) => {
