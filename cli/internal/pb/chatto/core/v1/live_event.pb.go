...
var file_chatto_core_v1_live_event_proto_goTypes = []any{
	...
	(*ServerUserPreferencesUpdatedEvent)(nil), // 5: chatto.core.v1.ServerUserPreferencesUpdatedEvent
