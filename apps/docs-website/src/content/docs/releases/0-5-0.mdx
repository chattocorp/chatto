...
<ReleaseFeatureGrid>
  ...
  <ReleaseFeatureCard title="More expressive messages">
    ...
    menu. Room managers can pin useful channel messages in a shared sidebar, with a subtle
    dot when a newer pin has not been viewed. Attachment sends now show per-file progress
    and preserve failed uploads for retry.
  </ReleaseFeatureCard>
