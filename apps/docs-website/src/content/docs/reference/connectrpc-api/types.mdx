...
<a id="chatto-api-v1-RoomConfig"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window` | `google.protobuf.Duration` | Maximum message age for author edits. Zero disables author edits. Users with message.manage remain unrestricted by this window. |

<a id="chatto-api-v1-RoomConfigSource"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `source.product_default` | `bool` | The value comes from Chatto's compiled product default. Must be true. |
| `source.server` | `bool` | The value comes from the server layer. Must be true. |
| `source.room_group_id` | `string` | The value comes from this room-group layer. |
| `source.room_id` | `string` | The value comes from this room layer. |

<a id="chatto-api-v1-RoomConfigSources"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window` | [`RoomConfigSource`](#chatto-api-v1-RoomConfigSource) | No field description provided. |
...
| `room_config` | [`RoomConfig`](#chatto-api-v1-RoomConfig) | Effective configuration governing this room for the current user. |
...
<a id="chatto-admin-v1-RoomConfigLayer"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window` | `google.protobuf.Duration` | Maximum message age for author edits. Zero disables author edits. Absence means inherit. Maximum: 30 days. |

<a id="chatto-admin-v1-RoomConfigScope"></a>
...
<a id="chatto-admin-v1-RoomConfigState"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `scope` | [`RoomConfigScope`](#chatto-admin-v1-RoomConfigScope) | Scope whose stored and resolved state is represented. |
| `layer` | [`RoomConfigLayer`](#chatto-admin-v1-RoomConfigLayer) | Sparse values stored directly at the scope. |
| `effective` | `chatto.api.v1.RoomConfig` | Fully resolved configuration at the scope. |
| `sources` | `chatto.api.v1.RoomConfigSources` | Scope or product default supplying each effective field. |
