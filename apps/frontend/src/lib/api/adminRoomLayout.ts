...
import { AdminRoomLayoutService } from '@chatto/api-types/chatto/api/v1/admin_room_layout_connect';
import {
...
} from '@chatto/api-types/chatto/api/v1/admin_room_layout_pb';
import type { SidebarLink } from '@chatto/api-types/chatto/api/v1/room_directory_pb';
