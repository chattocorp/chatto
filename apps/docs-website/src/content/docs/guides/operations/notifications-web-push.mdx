...
Each browser or installed PWA creates its own subscription. A user can have up to 16 subscribed devices, and each device receives the same push notification.
