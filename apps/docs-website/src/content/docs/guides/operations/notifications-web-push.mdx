...
Open the notification centre from the bell in the app header. It stays over
your current conversation as a compact anchored panel on desktop and a bottom
sheet on mobile. The Quick Switcher opens the same surface.

The centre shows one chronological list:
