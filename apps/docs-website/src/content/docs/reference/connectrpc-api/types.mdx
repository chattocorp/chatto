...
<a id="chatto-api-v1-ServerSnapshotChunk"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `resource.server` | [`ServerPublicProfile`](#chatto-api-v1-ServerPublicProfile) | Current public server profile. |
| `resource.motd` | [`GetMotdResponse`](/reference/connectrpc-api/server/#chatto-api-v1-GetMotdResponse) | Current authenticated message of the day. |
| `resource.runtime_config` | [`GetRuntimeConfigResponse`](/reference/connectrpc-api/server/#chatto-api-v1-GetRuntimeConfigResponse) | Current authenticated runtime configuration. |
| `resource.viewer` | [`GetViewerResponse`](/reference/connectrpc-api/viewer/#chatto-api-v1-GetViewerResponse) | Current authenticated viewer resource. |
| `resource.users` | [`ListUsersResponse`](/reference/connectrpc-api/users/#chatto-api-v1-ListUsersResponse) | Complete visible user directory. |
| `resource.rooms` | [`ListRoomsResponse`](/reference/connectrpc-api/room-directory/#chatto-api-v1-ListRoomsResponse) | Complete visible room directory. |
| `resource.room_groups` | [`ListRoomGroupsResponse`](/reference/connectrpc-api/room-directory/#chatto-api-v1-ListRoomGroupsResponse) | Complete visible room-group layout. |
| `resource.notifications` | [`ListNotificationOccurrencesResponse`](/reference/connectrpc-api/notifications/#chatto-api-v1-ListNotificationOccurrencesResponse) | Current bounded notification occurrence page and complete counts. |
| `resource.active_calls` | [`ListActiveCallsResponse`](/reference/connectrpc-api/calls/#chatto-api-v1-ListActiveCallsResponse) | Complete visible active-call state. |
