...
| `kind` | [`CallMediaPublisherKind`](/reference/connectrpc-api/types/#chatto-api-v1-CallMediaPublisherKind) | Required. Kind of native media publisher being started. |
...
| `e2ee_key` | `string` | Shared E2EE key for this active call. |
| `call_id` | `string` | Active call session ID. |
| `publisher_identity` | `string` | Opaque LiveKit identity for this companion connection. |
