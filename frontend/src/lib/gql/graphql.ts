...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanAttach: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, viewerCanBanRoomMembers: boolean, members: { __typename?: 'RoomMembersConnection', totalCount: number, hasMore: boolean, users: Array<(
        { __typename?: 'User' }
        & { ' $fragmentRefs'?: { 'UserAvatarUserFragment': UserAvatarUserFragment } }
