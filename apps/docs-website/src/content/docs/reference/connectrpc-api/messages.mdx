...
| `description` | `string` | Replacement description. Chatto trims outer whitespace, preserves internal line breaks, and permits at most 1,000 Unicode characters after trimming. An empty result clears the description. |
