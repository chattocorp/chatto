...
| [ADR-062](ADR-062-tanstack-query-for-snapshot-reads.md) | TanStack Query for Snapshot-Style Frontend Reads | Accepted | 2026-09-17 |
...
| [ADR-100](ADR-100-current-state-in-realtime-updates.md) | Include Current State in Frequent Realtime Updates | Accepted | 2026-09-20 |
