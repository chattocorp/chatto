...
| `latest_delivery` | [`BotWebhookDelivery`](#chatto-api-v1-BotWebhookDelivery) | Latest terminal delivery for this configuration, when available. |
...
| `attempts` | `uint32` | Reserved attempts, including requests with an uncertain crash outcome. |
