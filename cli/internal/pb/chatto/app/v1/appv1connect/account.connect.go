...
const (
	...
	AccountServiceName = "chatto.app.v1.AccountService"
)
...
const (
	...
	// UpdateProfile RPC.
	AccountServiceUpdateProfileProcedure = "/chatto.app.v1.AccountService/UpdateProfile"
	// AccountServiceUploadAvatarProcedure is the fully-qualified name of the AccountService's
	// UploadAvatar RPC.
	AccountServiceUploadAvatarProcedure = "/chatto.app.v1.AccountService/UploadAvatar"
	// AccountServiceDeleteAvatarProcedure is the fully-qualified name of the AccountService's
	// DeleteAvatar RPC.
	AccountServiceDeleteAvatarProcedure = "/chatto.app.v1.AccountService/DeleteAvatar"
	// AccountServiceUpdateSettingsProcedure is the fully-qualified name of the AccountService's
	// UpdateSettings RPC.
	AccountServiceUpdateSettingsProcedure = "/chatto.app.v1.AccountService/UpdateSettings"
	...
	AccountServiceRequestAccountDeletionProcedure = "/chatto.app.v1.AccountService/RequestAccountDeletion"
	// AccountServiceDeleteMyAccountProcedure is the fully-qualified name of the AccountService's
	// DeleteMyAccount RPC.
	AccountServiceDeleteMyAccountProcedure = "/chatto.app.v1.AccountService/DeleteMyAccount"
)

// AccountServiceClient is a client for the chatto.app.v1.AccountService service.
...
// NewAccountServiceClient constructs a client for the chatto.app.v1.AccountService service. By
...
func NewAccountServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccountServiceClient {
	...
	accountServiceMethods := v1.File_chatto_app_v1_account_proto.Services().ByName("AccountService").Methods()
...
// UpdateProfile calls chatto.app.v1.AccountService.UpdateProfile.
...
// UploadAvatar calls chatto.app.v1.AccountService.UploadAvatar.
...
// DeleteAvatar calls chatto.app.v1.AccountService.DeleteAvatar.
...
// UpdateSettings calls chatto.app.v1.AccountService.UpdateSettings.
...
// RequestAccountDeletion calls chatto.app.v1.AccountService.RequestAccountDeletion.
...
// DeleteMyAccount calls chatto.app.v1.AccountService.DeleteMyAccount.
...
// AccountServiceHandler is an implementation of the chatto.app.v1.AccountService service.
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountServiceHandler) UpdateProfile(context.Context, *connect.Request[v1.UpdateProfileRequest]) (*connect.Response[v1.UpdateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.UpdateProfile is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) UploadAvatar(context.Context, *connect.Request[v1.UploadAvatarRequest]) (*connect.Response[v1.UploadAvatarResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.UploadAvatar is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) DeleteAvatar(context.Context, *connect.Request[v1.DeleteAvatarRequest]) (*connect.Response[v1.DeleteAvatarResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.DeleteAvatar is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) UpdateSettings(context.Context, *connect.Request[v1.UpdateSettingsRequest]) (*connect.Response[v1.UpdateSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.UpdateSettings is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) RequestAccountDeletion(context.Context, *connect.Request[v1.RequestAccountDeletionRequest]) (*connect.Response[v1.RequestAccountDeletionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.RequestAccountDeletion is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) DeleteMyAccount(context.Context, *connect.Request[v1.DeleteMyAccountRequest]) (*connect.Response[v1.DeleteMyAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AccountService.DeleteMyAccount is not implemented"))
}
