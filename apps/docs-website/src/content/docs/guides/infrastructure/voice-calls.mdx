...
**Voice volume** for their microphone and **Stream volume** for shared audio.
The menu is also available on camera and screen-share cards, and from that
...
- **Audio level visualization** — A soft accent-coloured glow behind participant names grows brighter and broader with speaking volume, then fades away in silence. Video stays clear. Reduced motion keeps the glow stationary.
