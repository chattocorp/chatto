...
- [BotService](/reference/connectrpc-api/bots/) - Bot account lifecycle, API-key rotation, and delegated permission RPCs.
...
- [NotificationService](/reference/connectrpc-api/notifications/) - Exact notification occurrence listing, read, deletion, and per-signal-class policy RPCs.
