...
| Realtime event and state assembler | [`realtime_projection.go`](../../cli/internal/connectapi/realtime_projection.go), [`realtime_projection.go`](../../cli/internal/http_server/realtime_projection.go) | Authorized canonical event copies, snapshot state, and optional current-resource state derived from durable or transient events without exposing stored EVT bytes |
