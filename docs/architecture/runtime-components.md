...
| `evtstream.Reader`              | [`reader.go`](../../cli/internal/evtstream/reader.go)                                                                                                             | Typed exact-sequence EVT reads with bounded concurrency, duplicate removal, caller-order results, and leader-backed JetStream access for current read-your-writes behavior |
