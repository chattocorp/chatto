...
| `page` | [`PageInfo`](/reference/connectrpc-api/types/#chatto-api-v1-PageInfo) | Page metadata. |
| `active_message_event_ids` | `repeated string` | Canonical message event IDs for every active pin in the room, independent of pagination. Clients use this small index for authoritative actions. |
