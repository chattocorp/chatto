...
<EnvVar name="CHATTO_WEBSERVER_WEBSOCKET_COMPRESSION" toml="webserver.websocket_compression" default="true">
  Negotiate WebSocket compression. The realtime server compresses frames of at least 1 KiB with a low-memory Huffman-only encoder; smaller invalidation and heartbeat frames stay uncompressed.
</EnvVar>
