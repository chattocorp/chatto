...
- [ServerSetupService](/reference/connectrpc-api/server-setup/) - Public first-run server setup and initial owner creation.
...
- [PushSubscriptionCleanupService](/reference/connectrpc-api/push-subscription-cleanup/) - Public capability-authenticated cleanup for exact browser push subscriptions.
...
- [PermissionService](/reference/connectrpc-api/permissions/) - Read-only effective permissions for bot and human accounts.
- [BotService](/reference/connectrpc-api/bots/) - Bot account lifecycle and API-key management RPCs.
...
- [MyAccountService](/reference/connectrpc-api/account/) - Self-service account, profile, presence, status, external identity, and settings RPCs for the authenticated user.
- [NotificationService](/reference/connectrpc-api/notifications/) - Exact notification occurrence listing, read, and deletion RPCs.
- [NotificationPolicyService](/reference/connectrpc-api/notification-policies/) - Server, room-group, and room notification delivery policy RPCs for the authenticated viewer.
...
- [AdminOAuthClientService](/reference/connectrpc-api/admin-oauth-clients/) - Recorded OAuth-client authorization and policy administration RPCs.
