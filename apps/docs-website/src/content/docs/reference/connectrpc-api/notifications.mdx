...
Use these services to read notification state, update notification preferences, dismiss notifications, and manage web push subscriptions for the authenticated user.
