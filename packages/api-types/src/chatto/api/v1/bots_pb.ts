 ...
 *
 * @generated from message chatto.api.v1.BotPermissionCell
 */
export class BotPermissionCell extends Message<BotPermissionCell> {
  /**
   ...
   *
   * @generated from field: chatto.api.v1.BotPermissionDecision configured = 3;
   */
  configured = BotPermissionDecision.UNSPECIFIED;

  /**
   * Bot decision after its own scope inheritance, before the owner ceiling.
   *
   * @generated from field: chatto.api.v1.BotPermissionDecision delegated = 4;
   */
  delegated = BotPermissionDecision.UNSPECIFIED;

  /**
   * Whether the owner currently has this permission at the same scope.
   *
   * @generated from field: bool owner_granted = 5;
   */
  ownerGranted = false;
   ...
   *
   * @generated from field: bool effective_granted = 6;
   */
  effectiveGranted = false;

  constructor(data?: PartialMessage<BotPermissionCell>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.api.v1.BotPermissionCell";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "permission", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "scope_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "configured", kind: "enum", T: proto3.getEnumType(BotPermissionDecision) },
    { no: 4, name: "delegated", kind: "enum", T: proto3.getEnumType(BotPermissionDecision) },
    { no: 5, name: "owner_granted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 6, name: "effective_granted", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BotPermissionCell {
    return new BotPermissionCell().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): BotPermissionCell {
    return new BotPermissionCell().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): BotPermissionCell {
    return new BotPermissionCell().fromJsonString(jsonString, options);
  }

  static equals(a: BotPermissionCell | PlainMessage<BotPermissionCell> | undefined, b: BotPermissionCell | PlainMessage<BotPermissionCell> | undefined): boolean {
    return proto3.util.equals(BotPermissionCell, a, b);
  }
}
...
export class BotPermissionMatrix extends Message<BotPermissionMatrix> {
   ...
   *
   * @generated from field: repeated chatto.api.v1.BotPermissionCell cells = 4;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "cells", kind: "message", T: BotPermissionCell, repeated: true },
  ]);
...
export class SetBotPermissionRequest extends Message<SetBotPermissionRequest> {
   ...
   * Target scope.
   *
   * @generated from field: chatto.api.v1.BotPermissionScope scope = 3;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "scope", kind: "message", T: BotPermissionScope },
...
export class SetBotPermissionResponse extends Message<SetBotPermissionResponse> {
   ...
   *
   * @generated from field: chatto.api.v1.BotPermissionCell cell = 1;
   */
  cell?: BotPermissionCell;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "cell", kind: "message", T: BotPermissionCell },
  ]);
