---
title: Operator CLI
description: Manage accounts and channel rooms with the local chatto operator CLI.
---

import { Aside, Steps } from "@astrojs/starlight/components";

`chatto operator` provides local, root-equivalent account administration and channel room management. Use it to create the first account on a server, recover access, or manage channels from a script.
