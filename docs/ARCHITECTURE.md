...
| `/api/connect/chatto.admin.v1.AdminMemberService/CreateUser`                                   | `AdminMemberService`             | `CreateUser`                   | Authenticated; requires `user.manage-accounts`; role assignments also require `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system. | Create a user, optionally with password, verified email, and roles.                                                                                                                                     |
| `/api/connect/chatto.admin.v1.AdminMemberService/ListMembers`                                  | `AdminMemberService`             | `ListMembers`                  | Authenticated. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                                              | List server members for the admin members screen and operator CLI.                                                                                                                                      |
| `/api/connect/chatto.admin.v1.AdminMemberService/GetMember`                                    | `AdminMemberService`             | `GetMember`                    | Authenticated. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                                              | Read one server member plus role and permission metadata for admin details or operator lookup by ID/login.                                                                                              |
| `/api/connect/chatto.admin.v1.AdminMemberService/AssignRole`                                   | `AdminMemberService`             | `AssignRole`                   | Authenticated; requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                      | Assign a role to a user.                                                                                                                                                                               |
| `/api/connect/chatto.admin.v1.AdminMemberService/RevokeRole`                                   | `AdminMemberService`             | `RevokeRole`                   | Authenticated; requires `role.assign`; cannot revoke caller's own owner/admin role. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system. | Revoke a role from a user.                                                                                                                                                                             |
| `/api/connect/chatto.admin.v1.AdminMemberService/UpdateUser`                                   | `AdminMemberService`             | `UpdateUser`                   | Authenticated; self-target or requires `user.manage-accounts`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.              | Update a user's login and/or display name as an admin action.                                                                                                                                          |
| `/api/connect/chatto.admin.v1.AdminMemberService/SetUserPassword`                              | `AdminMemberService`             | `SetUserPassword`              | Authenticated; requires `user.manage-accounts`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                             | Set a user's password and advance their auth generation.                                                                                                                                                |
| `/api/connect/chatto.admin.v1.AdminMemberService/DeleteUser`                                   | `AdminMemberService`             | `DeleteUser`                   | Authenticated; requires `user.delete-any` for another user and rejects self-targets. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system. | Permanently delete another user through the normal account-deletion model.                                                                                                                              |
| `/api/connect/chatto.admin.v1.AdminMemberService/AddVerifiedEmail`                             | `AdminMemberService`             | `AddVerifiedEmail`             | Authenticated; requires `user.manage-accounts`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                             | Add an already-verified email address to a user.                                                                                                                                                        |
...
| `/api/connect/chatto.admin.v1.AdminRoleService/CreateRole`                                     | `AdminRoleService`               | `CreateRole`                    | Authenticated; requires `role.manage`.                                                                                                                             | Create a custom role.                                                                                                                                                                                  |
...
| `/api/connect/chatto.admin.v1.AdminRoleService/DeleteRole`                                     | `AdminRoleService`               | `DeleteRole`                    | Authenticated; requires `role.manage`; system roles cannot be deleted.                                                                                             | Delete a custom role.                                                                                                                                                                                  |
| `/api/connect/chatto.admin.v1.AdminRoleService/ReorderRoles`                                   | `AdminRoleService`               | `ReorderRoles`                  | Authenticated; requires `role.manage`; list must contain every custom role exactly once.                                                                           | Replace custom role ordering while system roles keep fixed positions.                                                                                                                                   |
