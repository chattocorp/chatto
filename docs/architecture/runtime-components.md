...
| `AssetUploadModel`               | [`asset_uploads.go`](../../cli/internal/core/asset_uploads.go)                                                                                                    | Eagerly wired chunked attachment upload sessions, bounded cross-replica direct-image import staging, temporary object assembly, pending-asset expiry, and process-local periodic cleanup |
