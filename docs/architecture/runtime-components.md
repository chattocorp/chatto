...
| Realtime event and snapshot assembler | [`server_snapshot.go`](../../cli/internal/connectapi/server_snapshot.go), [`realtime_projection.go`](../../cli/internal/http_server/realtime_projection.go) | Authorized canonical event copies and ordered snapshot chunks that reuse public ConnectRPC resource protobufs without exposing stored EVT bytes |
