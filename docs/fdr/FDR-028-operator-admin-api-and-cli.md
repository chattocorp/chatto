...
- The user-administration surface lives in `chatto.admin.v1.AdminMemberService` and can list and look up users, create users, update login/display name, set passwords, delete users, add verified email addresses, assign server roles, and revoke server roles.
