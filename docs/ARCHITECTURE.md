...
| `/api/connect/chatto.admin.v1.AdminMemberService/AssignRole`                                   | `AdminMemberService`             | `AssignRole`                   | Authenticated; requires `role.assign`.                                                                                                                             | Assign a role to a user.                                                                                                                                                                               |
| `/api/connect/chatto.admin.v1.AdminMemberService/RevokeRole`                                   | `AdminMemberService`             | `RevokeRole`                   | Authenticated; requires `role.assign`; cannot revoke caller's own owner/admin role.                                                                                | Revoke a role from a user.                                                                                                                                                                             |
