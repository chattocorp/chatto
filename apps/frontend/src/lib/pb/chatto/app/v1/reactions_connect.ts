 ...
 *
 * @generated from service chatto.app.v1.ReactionService
 */
export const ReactionService = {
  typeName: "chatto.app.v1.ReactionService",
  methods: {
    /**
     * Adds a reaction to a message. The user must be a room member and have
     * message.react in the target room.
     *
     * @generated from rpc chatto.app.v1.ReactionService.AddReaction
     */
    addReaction: {
      name: "AddReaction",
     ...
     * message.react in the target room.
     *
     * @generated from rpc chatto.app.v1.ReactionService.RemoveReaction
     */
    removeReaction: {
      name: "RemoveReaction",
