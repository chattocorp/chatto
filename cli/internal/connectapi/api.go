...
func (a *API) Handlers() []Handler {
	...
	personalDataPath, personalDataHandler := personaldataapiv1connect.NewPersonalDataServiceHandler(&personalDataService{api: a}, options...)
	handlers := []Handler{
		...
		{ServicePath: personalDataPath, Handler: personalDataHandler, AuthPolicy: AuthPolicyAuthenticatedUser},
	}
