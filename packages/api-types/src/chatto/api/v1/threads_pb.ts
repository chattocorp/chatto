...
export class ListFollowedThreadsRequest extends Message<ListFollowedThreadsRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "unread_only", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
...
export class ListFollowedThreadsResponse extends Message<ListFollowedThreadsResponse> {
   ...
   *
   * @generated from field: optional bool unread_only = 6;
   */
  unreadOnly?: boolean;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "unread_only", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
