...
| `profile` | [`chatto.api.v1.ServerMemberProfile`](/reference/connectrpc-api/types/#chatto-api-v1-ServerMemberProfile) | Effective server profile and branding. |
...
| Field | Type | Description |
| --- | --- | --- |
| `profile` | [`chatto.api.v1.ServerMemberProfile`](/reference/connectrpc-api/types/#chatto-api-v1-ServerMemberProfile) | Updated server profile and branding. |
