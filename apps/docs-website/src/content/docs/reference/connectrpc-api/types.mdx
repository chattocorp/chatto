...
<a id="chatto-api-v1-AssetThumbnailOptions"></a>
...
| `fit` | [`AssetFitMode`](#chatto-api-v1-AssetFitMode) | Thumbnail fit mode. |
...
<a id="chatto-api-v1-AssetFitMode"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ASSET_FIT_MODE_UNSPECIFIED` | `0` | The fit mode was not specified. |
| `ASSET_FIT_MODE_CONTAIN` | `1` | Preserve the whole source image within the requested bounds. |
| `ASSET_FIT_MODE_COVER` | `2` | Fill the requested bounds, cropping when needed. |
