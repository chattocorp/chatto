...
| `discovery_v1` | `bool` | Supports the `chatto.discovery.v1` public discovery contract. |
| `auth_v1` | `bool` | Supports the `chatto.auth.v1` public authentication contract. |
| `api_v1` | `bool` | Supports the `chatto.api.v1` public integration contract. |
| `admin_v1` | `bool` | Supports the `chatto.admin.v1` public administration contract. |
| `message_search_v1` | `bool` | Supports the `chatto.api.message-search.v1` message-search contract. |
| `realtime_v1` | `bool` | Supports the `chatto.realtime.v1` realtime transport contract. |
| `realtime_projection_v1` | `bool` | Supports the `chatto.realtime.projection.v1` client-projection contract. |
