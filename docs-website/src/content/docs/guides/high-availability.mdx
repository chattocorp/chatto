...
- **Server data** — users, memberships, configuration, roles, permissions, rooms, message bodies, reactions, threads, read status, call join/leave facts
...
- **LiveKit E2EE room keys** — regenerated when members reconnect to calls
