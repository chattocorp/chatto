...
export type Mutation = {
   ...
   * Status applies to one live browser tab/device session.
...
export type Subscription = {
   ...
   *
   * **Side effects:**
   * - Subscribing sets the given presence session to ONLINE.
...
export type SubscriptionMyEventsArgs = {
  presenceSessionId: Scalars['ID']['input'];
};
