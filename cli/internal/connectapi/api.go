...
func (a *API) Handlers() []Handler {
	...
	adminInvitationPath, adminInvitationHandler := adminv1connect.NewAdminInvitationServiceHandler(&adminInvitationService{api: a}, options...)
	...
	handlers := []Handler{
		...
		{ServicePath: adminInvitationPath, Handler: adminInvitationHandler, AuthPolicy: AuthPolicyAuthenticatedUser},
