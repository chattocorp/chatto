...
import type {
  ...
  RoomGroup,
  RoomGroupItem
} from '@chatto/api-types/chatto/api/v1/room_directory_pb';
import { RoomDirectoryScope } from '@chatto/api-types/chatto/api/v1/room_directory_pb';
import { RoomKind } from '@chatto/api-types/chatto/api/v1/rooms_pb';
