...
const (
	...
	UserServiceName = "chatto.app.v1.UserService"
)
...
const (
	...
	UserServiceGetUserProcedure = "/chatto.app.v1.UserService/GetUser"
	// UserServiceGetUserByLoginProcedure is the fully-qualified name of the UserService's
	// GetUserByLogin RPC.
	UserServiceGetUserByLoginProcedure = "/chatto.app.v1.UserService/GetUserByLogin"
	// UserServiceBatchGetUsersProcedure is the fully-qualified name of the UserService's BatchGetUsers
	// RPC.
	UserServiceBatchGetUsersProcedure = "/chatto.app.v1.UserService/BatchGetUsers"
)

// UserServiceClient is a client for the chatto.app.v1.UserService service.
...
// NewUserServiceClient constructs a client for the chatto.app.v1.UserService service. By default,
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_chatto_app_v1_users_proto.Services().ByName("UserService").Methods()
...
// GetUser calls chatto.app.v1.UserService.GetUser.
...
// GetUserByLogin calls chatto.app.v1.UserService.GetUserByLogin.
...
// BatchGetUsers calls chatto.app.v1.UserService.BatchGetUsers.
...
// UserServiceHandler is an implementation of the chatto.app.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUserByLogin(context.Context, *connect.Request[v1.GetUserByLoginRequest]) (*connect.Response[v1.GetUserByLoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.UserService.GetUserByLogin is not implemented"))
}
...
func (UnimplementedUserServiceHandler) BatchGetUsers(context.Context, *connect.Request[v1.BatchGetUsersRequest]) (*connect.Response[v1.BatchGetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.UserService.BatchGetUsers is not implemented"))
}
