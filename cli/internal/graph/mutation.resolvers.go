...
func (r *mutationResolver) CreateRoom(ctx context.Context, input model.CreateRoomInput) (*corev1.Room, error) {
	...
	can, err := r.core.CanCreateRoom(ctx, user.Id, core.KindForSpace(spaceID))
	if err != nil {
		return nil, err
	}
	if !can {
...
func (r *mutationResolver) UpdateRoom(ctx context.Context, input model.UpdateRoomInput) (*corev1.Room, error) {
	...
	can, err := r.core.CanAdminRoomsManage(ctx, user.Id, core.KindForSpace(spaceID))
	if err != nil {
		return nil, err
	}
	if !can {
...
func (r *mutationResolver) PostMessage(ctx context.Context, input model.PostMessageInput) (*corev1.Event, error) {
	...
	if core.IsDMSpace(spaceID) {
		...
		can, err := r.core.CanPostInThread(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return nil, err
		}
		if !can {
		...
		can, err := r.core.CanPostMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return nil, err
		}
		if !can {
	...
	if !core.IsDMSpace(spaceID) && input.InReplyTo != nil && *input.InReplyTo != "" {
		if input.InThread != nil && *input.InThread != "" {
			...
			can, err := r.core.CanReplyInThread(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
			if err != nil {
				return nil, err
			}
			if !can {
			...
			can, err := r.core.CanReply(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
			if err != nil {
				return nil, err
			}
			if !can {
	...
	if alsoSendToChannel {
		...
		can, err := r.core.CanEchoMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return nil, err
		}
		if !can {
...
func (r *mutationResolver) JoinRoom(ctx context.Context, input model.JoinRoomInput) (bool, error) {
	...
	can, err := r.core.CanJoinRoom(ctx, user.Id, core.KindForSpace(spaceID))
	if err != nil {
		return false, err
	}
	if !can {
...
func (r *mutationResolver) AddReaction(ctx context.Context, input model.AddReactionInput) (bool, error) {
	...
	can, err := r.core.CanReactToMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
	if err != nil {
		return false, err
	}
	if !can {
...
func (r *mutationResolver) SendTypingIndicator(ctx context.Context, input model.SendTypingIndicatorInput) (bool, error) {
	...
	if err := r.core.PublishTypingIndicator(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID, input.ThreadRootEventID); err != nil {
		return false, err
	}
...
func (r *mutationResolver) DeleteMessage(ctx context.Context, input model.DeleteMessageInput) (bool, error) {
	...
	if user.Id == authorID {
		...
		can, err := r.core.CanDeleteOwnMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return false, err
		}
		if !can {
		...
		can, err := r.core.CanDeleteAnyMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return false, err
		}
		if !can {
...
func (r *mutationResolver) EditMessage(ctx context.Context, input model.EditMessageInput) (bool, error) {
	...
	if isAuthor {
		can, err := r.core.CanEditOwnMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return false, err
		}
		if !can {
		...
		can, err := r.core.CanEditAnyMessage(ctx, user.Id, core.KindForSpace(spaceID), input.RoomID)
		if err != nil {
			return false, err
		}
		if !can {
