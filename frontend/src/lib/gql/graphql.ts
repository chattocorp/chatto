...
export type AdminRoomSetsQuery = { __typename?: 'Query', server: { __typename?: 'Server', rooms: Array<{ __typename?: 'Room', id: string, name: string, description?: string | null, archived: boolean, autoJoin: boolean }>, roomSets: Array<{ __typename?: 'RoomSet', id: string, name: string, rooms: Array<{ __typename?: 'Room', id: string }> }> } };
