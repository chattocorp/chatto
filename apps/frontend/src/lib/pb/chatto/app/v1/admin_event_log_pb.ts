...
// @generated from file chatto/app/v1/admin_event_log.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.app.v1.AdminEventLogFilter
 */
export class AdminEventLogFilter extends Message<AdminEventLogFilter> {
  ...
  static readonly typeName = "chatto.app.v1.AdminEventLogFilter";
 ...
 *
 * @generated from message chatto.app.v1.ListEventsRequest
 */
export class ListEventsRequest extends Message<ListEventsRequest> {
   ...
   *
   * @generated from field: chatto.app.v1.AdminEventLogFilter filter = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListEventsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.ListEventsResponse
 */
export class ListEventsResponse extends Message<ListEventsResponse> {
  /**
   * Event-log rows.
   *
   * @generated from field: repeated chatto.app.v1.AdminEventLogEntry entries = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListEventsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.ListEventTypesRequest
 */
export class ListEventTypesRequest extends Message<ListEventTypesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListEventTypesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message chatto.app.v1.ListEventTypesResponse
 */
export class ListEventTypesResponse extends Message<ListEventTypesResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListEventTypesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.GetEventRequest
 */
export class GetEventRequest extends Message<GetEventRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetEventRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.GetEventResponse
 */
export class GetEventResponse extends Message<GetEventResponse> {
  /**
   * Entry is absent when the requested sequence does not exist.
   *
   * @generated from field: optional chatto.app.v1.AdminEventLogEntry entry = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.AdminEventLogEntry
 */
export class AdminEventLogEntry extends Message<AdminEventLogEntry> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.AdminEventLogEntry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sequence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
