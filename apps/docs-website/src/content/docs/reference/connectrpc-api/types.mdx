...
| `client_uri` | `string` | Informational application URL from validated client metadata, when present. |
...
| `first_observed_at` | `google.protobuf.Timestamp` | When this server first completed an authorization for the client. |
| `last_observed_at` | `google.protobuf.Timestamp` | When this server most recently completed an authorization for the client. |
