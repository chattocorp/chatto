...
| Field | Type | Description |
| --- | --- | --- |
| `protocol_capabilities` | `repeated string` | Stable protocol capability keys supported by this server. Current keys: `chatto.discovery.v1`, `chatto.auth.v1`, `chatto.api.v1`, `chatto.admin.v1`, `chatto.api.bots.v1`, `chatto.api.message-search.v1`, `chatto.api.room-manager-member-reads.v1`, `chatto.realtime.v1`, and `chatto.realtime.projection.v1`. |
...
<a id="chatto-api-v1-BotAccountProfile"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `owner_id` | `string` | Stable user ID of the human account responsible for the bot. |
| `description` | `string` | Explanation of the bot's purpose and relevant data handling. |

<a id="chatto-api-v1-HumanAccountProfile"></a>
...
| `account_profile.human` | [`HumanAccountProfile`](#chatto-api-v1-HumanAccountProfile) | Human account profile. |
| `account_profile.bot` | [`BotAccountProfile`](#chatto-api-v1-BotAccountProfile) | Bot account profile, including accountable ownership and disclosure. |
...
| Field | Type | Description |
| --- | --- | --- |
| `user` | [`User`](#chatto-api-v1-User) | Public bot account identity and bot profile. The login always ends in `_bot` and the account profile is always `bot`. |
| `created_at` | `google.protobuf.Timestamp` | Account creation time. |
| `api_key` | [`BotAPIKey`](#chatto-api-v1-BotAPIKey) | Active API-key metadata, when a key has been issued. The secret is never returned by bot reads. |
...
| Field | Type | Description |
| --- | --- | --- |
| `created_at` | `google.protobuf.Timestamp` | Time at which the active key was issued. |

<a id="chatto-api-v1-BotPermissionDecisionUpdate"></a>

### BotPermissionDecisionUpdate
...
| `scope` | [`BotPermissionScope`](#chatto-api-v1-BotPermissionScope) | Scope at which the direct decision was stored. |
| `decision` | [`BotPermissionDecision`](#chatto-api-v1-BotPermissionDecision) | Stored direct decision. NONE means the previous decision was cleared. |

<a id="chatto-api-v1-BotPermissionMatrix"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `bot_id` | `string` | Bot account ID. |
| `applicable_permissions` | `repeated string` | Permissions rendered as rows. |
| `scopes` | repeated [`BotPermissionMatrixScope`](#chatto-api-v1-BotPermissionMatrixScope) | Scopes rendered as columns. |
| `cells` | repeated [`BotPermissionMatrixCell`](#chatto-api-v1-BotPermissionMatrixCell) | Sparse matrix cells. |

<a id="chatto-api-v1-BotPermissionMatrixCell"></a>

### BotPermissionMatrixCell
...
| --- | --- | --- |
| `permission` | `string` | Permission identifier. |
| `scope_id` | `string` | Scope ID matching BotPermissionMatrixScope.id. |
| `direct_decision` | [`BotPermissionDecision`](#chatto-api-v1-BotPermissionDecision) | Bot's explicit direct decision at this scope. |
| `effective_decision` | [`BotPermissionDecision`](#chatto-api-v1-BotPermissionDecision) | Bot's effective decision after inheritance and the owner ceiling. |
| `owner_allowed` | `bool` | Whether the owner currently has this permission at this scope. |

<a id="chatto-api-v1-BotPermissionMatrixScope"></a>

### BotPermissionMatrixScope

Matrix column describing one server, group, or room scope.

| Field | Type | Description |
| --- | --- | --- |
| `id` | `string` | Stable matrix scope ID. |
| `label` | `string` | Human-readable scope label. |
| `kind` | [`BotPermissionScopeKind`](#chatto-api-v1-BotPermissionScopeKind) | Scope tier. |
...
| --- | --- | --- |
| `kind` | [`BotPermissionScopeKind`](#chatto-api-v1-BotPermissionScopeKind) | Scope tier. |
| `id` | `string` | Group or room ID. Empty for server scope. |
...
| `owner_ceiling` | [`PermissionExplanation`](#chatto-admin-v1-PermissionExplanation) | Owner's independently resolved decision when the target is a bot. This exposes the delegation ceiling separately from the bot's own trace. |
...
<a id="chatto-api-v1-BotPermissionDecision"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `BOT_PERMISSION_DECISION_UNSPECIFIED` | `0` | Unspecified decision; rejected for writes. |
| `BOT_PERMISSION_DECISION_ALLOW` | `1` | Explicit allow. |
| `BOT_PERMISSION_DECISION_DENY` | `2` | Explicit deny. |
| `BOT_PERMISSION_DECISION_NONE` | `3` | No direct decision; clears the decision on writes. |

<a id="chatto-api-v1-BotPermissionScopeKind"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `BOT_PERMISSION_SCOPE_KIND_UNSPECIFIED` | `0` | Unspecified scope; treated as server scope for compatibility. |
| `BOT_PERMISSION_SCOPE_KIND_SERVER` | `1` | Server tier. |
| `BOT_PERMISSION_SCOPE_KIND_GROUP` | `2` | Room-group tier. |
| `BOT_PERMISSION_SCOPE_KIND_ROOM` | `3` | Room tier. |
