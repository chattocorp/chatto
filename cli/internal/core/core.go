...
func NewChattoCore(ctx context.Context, nc *nats.Conn, cfg config.CoreConfig) (*ChattoCore, error) {
	...
	if snapshotRepository != nil {
		...
		specs := []snapshotSpec{
			{projectionsnapshot.ProjectionThreadsKey, threadSnapshotContractID, threadsProjector},
			{projectionsnapshot.ProjectionRoomDirectoryKey, roomDirectorySnapshotContractID, roomDirectoryProjector},
			{projectionsnapshot.ProjectionServerConfigKey, configSnapshotContractID, serverConfigProjector},
			{projectionsnapshot.ProjectionRoomGroupLayoutKey, roomGroupLayoutSnapshotContractID, roomGroupLayoutProjector},
			{projectionsnapshot.ProjectionRoomTimelineKey, roomTimelineSnapshotContractID, roomTimelineProjector},
			{projectionsnapshot.ProjectionCallStateKey, callStateSnapshotContractID, callStateProjector},
			{projectionsnapshot.ProjectionAssetsKey, assetSnapshotContractID, assetProjector},
			{projectionsnapshot.ProjectionReactionsKey, reactionSnapshotContractID, reactionsProjector},
			{projectionsnapshot.ProjectionContentKeysKey, contentKeySnapshotContractID, contentKeysProjector},
			{projectionsnapshot.ProjectionRBACKey, rbacSnapshotContractID, rbacProjector},
			{projectionsnapshot.ProjectionMentionablesKey, mentionablesSnapshotContractID, mentionablesProjector},
			{projectionsnapshot.ProjectionUsersKey, userSnapshotContractID, usersProjector},
		}
		for _, spec := range specs {
			...
			snapshotJobs = append(snapshotJobs, projectionSnapshotJob{projector: spec.projector, repository: snapshotRepository, projectionKey: spec.key, contractID: spec.contractID, streamName: streamName, streamIdentity: snapshotStreamIdentity})
