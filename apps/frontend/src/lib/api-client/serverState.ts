...
export async function getAuthenticatedServerState(
  ...
  return {
    ...
    viewerCanBanRoomMembers: can('room.manage.bans'),
    viewerCanPostMessages: can('message.post'),
    viewerCanPostInThreads: can('message.post.replies'),
    ...
    viewerCanAssignRoles: can('role.manage.assignments'),
    viewerCanViewAdminUsers: can('user.read'),
    viewerCanViewAdminSystem: capability('admin.view-system'),
    viewerCanViewAdminAudit: can('audit.read'),
    viewerCanDeleteAnyUser: can('user.delete'),
