...
// @generated from file chatto/core/evt/v1/moderation_events.proto (package chatto.core.evt.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.core.evt.v1.RoomMemberBannedEvent
 */
export class RoomMemberBannedEvent extends Message<RoomMemberBannedEvent> {
  ...
  static readonly typeName = "chatto.core.evt.v1.RoomMemberBannedEvent";
 ...
 * target.
 *
 * @generated from message chatto.core.evt.v1.RoomMemberUnbannedEvent
 */
export class RoomMemberUnbannedEvent extends Message<RoomMemberUnbannedEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.core.evt.v1.RoomMemberUnbannedEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "user_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "reason", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * target.
 *
 * @generated from message chatto.core.evt.v1.RoomMemberAddedEvent
 */
export class RoomMemberAddedEvent extends Message<RoomMemberAddedEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.core.evt.v1.RoomMemberAddedEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "user_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 * target.
 *
 * @generated from message chatto.core.evt.v1.RoomMemberRemovedEvent
 */
export class RoomMemberRemovedEvent extends Message<RoomMemberRemovedEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.core.evt.v1.RoomMemberRemovedEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "user_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
