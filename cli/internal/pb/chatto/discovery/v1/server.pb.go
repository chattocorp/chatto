...
type ServerCompatibility struct {
	...
	MinimumWebClientVersion *string `protobuf:"bytes,1,opt,name=minimum_web_client_version,json=minimumWebClientVersion,proto3,oneof" json:"minimum_web_client_version,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_chatto_discovery_v1_server_proto_rawDesc = "" +
	...
	"\rcompatibility\x18\x03 \x01(\v2(.chatto.discovery.v1.ServerCompatibilityR\rcompatibility\"v\n" +
	"\x13ServerCompatibility\x12@\n" +
	"\x1aminimum_web_client_version\x18\x01 \x01(\tH\x00R\x17minimumWebClientVersion\x88\x01\x01B\x1d\n" +
