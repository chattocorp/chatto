...
In **Settings → Profile**, the bio field uses your selected Markdown or visual editor and the same formatting toolbar. Use **Save** to save your changes. The bio limit is 1,000 characters, including Markdown syntax.

Profile bios use the same Markdown formatting as messages, including paragraphs, headings, lists, quotes, code blocks, tables, links, and timestamps.
...
Select **Copy to clipboard** on a rendered code block to copy its code without the Markdown fence or line numbers.
