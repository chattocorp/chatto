---
title: Operator CLI
description: Manage accounts and find channel rooms with the local chatto operator CLI.
---

import { Aside, Steps } from "@astrojs/starlight/components";

`chatto operator` provides local, root-equivalent account administration and channel room lookup. Use it to create the first account on a server, recover access, or find channel IDs for a script.
