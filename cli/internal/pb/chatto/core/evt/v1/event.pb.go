...
type Event struct {
	...
	//	*Event_UserPresencePreferenceChanged
...
func (x *Event) GetUserPresencePreferenceChanged() *UserPresencePreferenceChangedEvent {
	if x != nil {
		if x, ok := x.Event.(*Event_UserPresencePreferenceChanged); ok {
			return x.UserPresencePreferenceChanged
		}
	}
	return nil
}
...
func (x *Event) GetUserPrimaryEmailChanged() *UserPrimaryEmailChangedEvent {
	if x != nil {
		if x, ok := x.Event.(*Event_UserPrimaryEmailChanged); ok {
			return x.UserPrimaryEmailChanged
		}
	}
	return nil
}
...
type Event_UserPresencePreferenceChanged struct {
	UserPresencePreferenceChanged *UserPresencePreferenceChangedEvent `protobuf:"bytes,525,opt,name=user_presence_preference_changed,json=userPresencePreferenceChanged,proto3,oneof"`
}
...
type Event_UserPrimaryEmailChanged struct {
	UserPrimaryEmailChanged *UserPrimaryEmailChangedEvent `protobuf:"bytes,728,opt,name=user_primary_email_changed,json=userPrimaryEmailChanged,proto3,oneof"`
}
...
func (*Event_UserPresencePreferenceChanged) isEvent_Event() {}
...
func (*Event_UserPrimaryEmailChanged) isEvent_Event() {}
...
const file_chatto_core_evt_v1_event_proto_rawDesc = "" +
	...
	"\x1duser_timezone_sharing_changed\x18\x88\x04 \x01(\v23.chatto.core.evt.v1.UserTimezoneSharingChangedEventH\x00R\x1auserTimezoneSharingChanged\x12\x82\x01\n" +
	" user_presence_preference_changed\x18\x8d\x04 \x01(\v26.chatto.core.evt.v1.UserPresencePreferenceChangedEventH\x00R\x1duserPresencePreferenceChanged\x12i\n" +
	...
	"\x13bot_api_key_revoked\x18\xd7\x05 \x01(\v2).chatto.core.evt.v1.BotApiKeyRevokedEventH\x00R\x10botApiKeyRevoked\x12p\n" +
	"\x1auser_primary_email_changed\x18\xd8\x05 \x01(\v20.chatto.core.evt.v1.UserPrimaryEmailChangedEventH\x00R\x17userPrimaryEmailChanged\x12W\n" +
...
var file_chatto_core_evt_v1_event_proto_goTypes = []any{
	...
	(*UserPresencePreferenceChangedEvent)(nil),          // 54: chatto.core.evt.v1.UserPresencePreferenceChangedEvent
...
var file_chatto_core_evt_v1_event_proto_depIdxs = []int32{
	...
	54,  // 53: chatto.core.evt.v1.Event.user_presence_preference_changed:type_name -> chatto.core.evt.v1.UserPresencePreferenceChangedEvent
...
func file_chatto_core_evt_v1_event_proto_init() {
	...
	file_chatto_core_evt_v1_event_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*Event_UserPresencePreferenceChanged)(nil),
		...
		(*Event_UserPrimaryEmailChanged)(nil),
