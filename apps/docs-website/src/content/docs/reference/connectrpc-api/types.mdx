...
| `latest_delivery` | [`BotWebhookDelivery`](#chatto-api-v1-BotWebhookDelivery) | Latest retained failure for this endpoint. Absent when no failure is retained. Later successes do not clear it. Absence does not prove successful delivery. |
