...
const (
	...
	AttachmentServiceName = "chatto.app.v1.AttachmentService"
)
...
const (
	...
	AttachmentServiceListRoomAttachmentsProcedure = "/chatto.app.v1.AttachmentService/ListRoomAttachments"
	...
	AttachmentServiceRefreshMessageAttachmentUrlsProcedure = "/chatto.app.v1.AttachmentService/RefreshMessageAttachmentUrls"
)

// AttachmentServiceClient is a client for the chatto.app.v1.AttachmentService service.
...
// NewAttachmentServiceClient constructs a client for the chatto.app.v1.AttachmentService service.
...
func NewAttachmentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AttachmentServiceClient {
	...
	attachmentServiceMethods := v1.File_chatto_app_v1_attachments_proto.Services().ByName("AttachmentService").Methods()
...
// ListRoomAttachments calls chatto.app.v1.AttachmentService.ListRoomAttachments.
...
// RefreshMessageAttachmentUrls calls chatto.app.v1.AttachmentService.RefreshMessageAttachmentUrls.
...
// AttachmentServiceHandler is an implementation of the chatto.app.v1.AttachmentService service.
...
func NewAttachmentServiceHandler(svc AttachmentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.AttachmentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAttachmentServiceHandler) ListRoomAttachments(context.Context, *connect.Request[v1.ListRoomAttachmentsRequest]) (*connect.Response[v1.ListRoomAttachmentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AttachmentService.ListRoomAttachments is not implemented"))
}
...
func (UnimplementedAttachmentServiceHandler) RefreshMessageAttachmentUrls(context.Context, *connect.Request[v1.RefreshMessageAttachmentUrlsRequest]) (*connect.Response[v1.RefreshMessageAttachmentUrlsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.AttachmentService.RefreshMessageAttachmentUrls is not implemented"))
}
