...
export type MyServerEventsSubscription = { __typename?: 'Subscription', myEvents: { __typename?: 'Event', id: string, createdAt: any, actorId: string, actor?: (
      ...
      | { __typename: 'RoomMemberBannedEvent', roomId: string, userId: string }
      | { __typename: 'RoomMemberUnbannedEvent', roomId: string, userId: string }
...
export type AdminRoomBansQuery = { __typename?: 'Query', admin?: { __typename?: 'AdminQueries', roomBans: Array<{ __typename?: 'RoomBan', id: string, roomId: string, userId: string, moderatorId: string, reason: string, createdAt: any, expiresAt?: any | null, room?: { __typename?: 'Room', id: string, name: string } | null, user?: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, presenceStatus: PresenceStatus } | null, moderator?: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null, presenceStatus: PresenceStatus } | null }> } | null };
