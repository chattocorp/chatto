...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, viewerCanBanRoomMembers: boolean } | null, server: { __typename?: 'Server', viewerCanManageRooms: boolean, profile: { __typename?: 'ServerProfile', name: string } } };
