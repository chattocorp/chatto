...
<a id="chatto-discovery-v1-Neighbor"></a>
...
| `testimonial` | `optional string` | Optional explanation from the recommending server's operator. |
...
| `attention_level` | [`ThreadAttentionLevel`](#chatto-api-v1-ThreadAttentionLevel) | Current notification attention for this thread. |
...
<a id="chatto-api-v1-ThreadAttentionLevel"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `THREAD_ATTENTION_LEVEL_UNSPECIFIED` | `0` | The thread does not have notification attention. |
| `THREAD_ATTENTION_LEVEL_AMBIENT` | `1` | The thread has neutral notification or Badge attention. |
| `THREAD_ATTENTION_LEVEL_IMPORTANT` | `2` | The thread has unread notification attention. |
