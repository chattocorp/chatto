...
func (chattoInitTheme) Theme(isDark bool) *huh.Styles {
	...
	styles.Group.Description = styles.Group.Description.Foreground(muted).PaddingBottom(1)
	styles.Focused.Title = styles.Focused.Title.Foreground(indigo).Bold(true)
	styles.Focused.Description = styles.Focused.Description.Foreground(muted).PaddingBottom(1)
	...
	styles.Blurred.Description = styles.Blurred.Description.Foreground(muted).PaddingBottom(1)
