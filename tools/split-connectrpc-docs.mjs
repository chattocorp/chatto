...
function renderLanding() {
  const lines = [
    ...
    '',
    'Successful unary JSON calls return the protobuf response message as JSON. Field names use protobuf JSON casing, such as `authMethods` and `registrationOpen`.',
    '',
