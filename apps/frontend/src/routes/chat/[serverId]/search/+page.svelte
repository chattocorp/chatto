      ...
      {#if store.statusLoading && !store.statusLoaded}
        <Panel>
          <div class="flex min-h-64 items-center justify-center text-muted" aria-live="polite">
            <span class="me-2 iconify animate-spin icon-[uil--spinner-alt]" aria-hidden="true"></span>
            {m['search.checking']()}
          </div>
        </Panel>
                ...
                {#if store.nextCursor}
                  ...
                  >
                    {#if store.loadingMore}
                      <span class="me-2 iconify animate-spin icon-[uil--spinner-alt]" aria-hidden="true"
                      ></span>
