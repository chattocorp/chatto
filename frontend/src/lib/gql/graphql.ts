...
export type MessagePreviewQuery = { __typename?: 'Query', roomEventByEventId?: { __typename?: 'SpaceEvent', id: string, createdAt: any, actor?: { __typename?: 'User', id: string, login: string, displayName: string, avatarUrl?: string | null } | null, event:
      | { __typename: 'CallParticipantJoinedEvent' }
      | { __typename: 'CallParticipantLeftEvent' }
      | { __typename: 'MessageDeletedEvent' }
      | { __typename: 'MessagePostedEvent', body?: string | null, inThread?: string | null }
      | { __typename: 'MessageUpdatedEvent' }
      | { __typename: 'PresenceChangedEvent' }
      | { __typename: 'ReactionAddedEvent' }
      | { __typename: 'ReactionRemovedEvent' }
