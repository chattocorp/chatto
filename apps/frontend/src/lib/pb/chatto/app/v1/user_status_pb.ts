...
// @generated from file chatto/app/v1/user_status.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.app.v1.CustomUserStatus
 */
export class CustomUserStatus extends Message<CustomUserStatus> {
  ...
  static readonly typeName = "chatto.app.v1.CustomUserStatus";
 ...
 *
 * @generated from message chatto.app.v1.SetCustomStatusRequest
 */
export class SetCustomStatusRequest extends Message<SetCustomStatusRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetCustomStatusRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "emoji", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "text", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "expires_at", kind: "message", T: Timestamp },
 ...
 *
 * @generated from message chatto.app.v1.SetCustomStatusResponse
 */
export class SetCustomStatusResponse extends Message<SetCustomStatusResponse> {
   ...
   *
   * @generated from field: chatto.app.v1.CustomUserStatus status = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetCustomStatusResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.ClearCustomStatusRequest
 */
export class ClearCustomStatusRequest extends Message<ClearCustomStatusRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ClearCustomStatusRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message chatto.app.v1.ClearCustomStatusResponse
 */
export class ClearCustomStatusResponse extends Message<ClearCustomStatusResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ClearCustomStatusResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "status", kind: "message", T: CustomUserStatus },
  ]);
