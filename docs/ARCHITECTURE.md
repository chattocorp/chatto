...
| `/api/connect/chatto.admin.v1.AdminMemberService/CreateUser`                                   | `AdminMemberService`             | `CreateUser`                   | Authenticated; requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                      | Create a user, optionally with password, verified email, and roles.                                                                                                                                     |
...
| `/api/connect/chatto.admin.v1.AdminMemberService/UpdateUser`                                   | `AdminMemberService`             | `UpdateUser`                   | Authenticated; self-target or requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                       | Update a user's login and/or display name as an admin action.                                                                                                                                          |
| `/api/connect/chatto.admin.v1.AdminMemberService/SetUserPassword`                              | `AdminMemberService`             | `SetUserPassword`              | Authenticated; requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                      | Set a user's password and advance their auth generation.                                                                                                                                                |
...
| `/api/connect/chatto.admin.v1.AdminMemberService/AddVerifiedEmail`                             | `AdminMemberService`             | `AddVerifiedEmail`             | Authenticated; requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                      | Add an already-verified email address to a user.                                                                                                                                                        |
