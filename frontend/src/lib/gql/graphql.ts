...
export type ComposerMentionRolesQuery = { __typename?: 'Query', server: { __typename?: 'Server', roles: Array<{ __typename?: 'Role', name: string, isSystem: boolean, position: number }> } };
...
export type RoomMentionRolesQuery = { __typename?: 'Query', server: { __typename?: 'Server', roles: Array<{ __typename?: 'Role', name: string, isSystem: boolean, position: number }> } };
