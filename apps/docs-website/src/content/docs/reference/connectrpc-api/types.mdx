...
| Field | Type | Description |
| --- | --- | --- |
| `protocol_capabilities` | `repeated string` | Stable protocol capability keys supported by this server. Current keys: `chatto.discovery.v1`, `chatto.auth.v1`, `chatto.api.v1`, `chatto.admin.v1`, and `chatto.realtime.v1`. |
...
<a id="chatto-discovery-v1-ServerFeatures"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `client_sync` | `bool` | Whether this server accepts authenticated client-sync data and can be selected as a home server. |
...
<a id="chatto-clientsync-api-v1-KnownServer"></a>
...
<a id="chatto-clientsync-api-v1-Preferences"></a>
...
| `time_format` | optional [`TimeFormat`](#chatto-clientsync-api-v1-TimeFormat) | Preferred time display format. |
...
<a id="chatto-clientsync-api-v1-TimeFormat"></a>
