...
| `description` | `string` | Plain-text description. Chatto trims outer whitespace, preserves internal line breaks, permits at most 1,000 Unicode characters after trimming, and omits an empty result. |
