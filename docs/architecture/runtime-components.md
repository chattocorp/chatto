...
| Realtime event and consistency boundary | [`realtime.go`](../../cli/internal/http_server/realtime.go), [`realtime_consistency.go`](../../cli/internal/connectapi/realtime_consistency.go), [`realtime_replay.go`](../../cli/internal/core/realtime_replay.go) | Authorized canonical event copies, opaque `E`-to-`F` catch-up, and cursor-bounded ConnectRPC reads without exposing stored EVT bytes or broker coordinates |
