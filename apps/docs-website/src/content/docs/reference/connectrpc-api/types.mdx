...
| `intensity` | [`NotificationDeliveryIntensity`](#chatto-api-v1-NotificationDeliveryIntensity) | Effective delivery intensity when the signal was emitted. |
...
| Field | Type | Description |
| --- | --- | --- |
| `kind` | [`NotificationPolicyKind`](#chatto-api-v1-NotificationPolicyKind) | Notification signal class controlled by this row. |
...
<a id="chatto-api-v1-NotificationPolicyKind"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `NOTIFICATION_POLICY_KIND_UNSPECIFIED` | `0` | No cause was specified. This value is not valid in preference writes. |
| `NOTIFICATION_POLICY_KIND_DIRECT_MESSAGE` | `1` | A message was posted in a direct-message conversation. |
| `NOTIFICATION_POLICY_KIND_DIRECT_MENTION` | `2` | The viewer's username was mentioned directly. |
| `NOTIFICATION_POLICY_KIND_REPLY` | `3` | Activity replied directly to the viewer's message. |
| `NOTIFICATION_POLICY_KIND_ROLE_MENTION` | `4` | A role held by the viewer was mentioned. |
| `NOTIFICATION_POLICY_KIND_HERE` | `5` | An `@here` mention included the viewer. |
| `NOTIFICATION_POLICY_KIND_ALL` | `6` | An `@all` mention included the viewer. |
| `NOTIFICATION_POLICY_KIND_FOLLOWED_THREAD` | `7` | New activity appeared in a thread followed by the viewer. |
| `NOTIFICATION_POLICY_KIND_FOLLOWED_ROOM` | `8` | New activity appeared in a room followed by the viewer. |
| `NOTIFICATION_POLICY_KIND_REACTION` | `9` | Someone reacted to the viewer's message. |
