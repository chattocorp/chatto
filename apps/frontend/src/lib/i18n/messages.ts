...
const msg_client_sync_settings_title = (): LocalizedString => messages().client_sync_settings_title(empty());
const msg_client_sync_settings_subtitle = (): LocalizedString => messages().client_sync_settings_subtitle(empty());
const msg_client_sync_settings_save_failed = (): LocalizedString => messages().client_sync_settings_save_failed(empty());
const msg_client_sync_settings_home_title = (): LocalizedString => messages().client_sync_settings_home_title(empty());
const msg_client_sync_settings_home_description = (): LocalizedString => messages().client_sync_settings_home_description(empty());
const msg_client_sync_settings_home_add_server_first = (): LocalizedString => messages().client_sync_settings_home_add_server_first(empty());
const msg_client_sync_settings_home_choose_prompt = (): LocalizedString => messages().client_sync_settings_home_choose_prompt(empty());
const msg_client_sync_settings_home_no_capable_server = (): LocalizedString => messages().client_sync_settings_home_no_capable_server(empty());
const msg_client_sync_settings_sync_local = (): LocalizedString => messages().client_sync_settings_sync_local(empty());
const msg_client_sync_settings_sync_loading = (): LocalizedString => messages().client_sync_settings_sync_loading(empty());
const msg_client_sync_settings_sync_synced = (): LocalizedString => messages().client_sync_settings_sync_synced(empty());
const msg_client_sync_settings_sync_unavailable = (): LocalizedString => messages().client_sync_settings_sync_unavailable(empty());
const msg_client_sync_settings_sync_error = (): LocalizedString => messages().client_sync_settings_sync_error(empty());
...
export { msg_client_sync_settings_title as 'client_sync.settings.title' };
export { msg_client_sync_settings_subtitle as 'client_sync.settings.subtitle' };
export { msg_client_sync_settings_save_failed as 'client_sync.settings.save_failed' };
export { msg_client_sync_settings_home_title as 'client_sync.settings.home.title' };
export { msg_client_sync_settings_home_description as 'client_sync.settings.home.description' };
export { msg_client_sync_settings_home_add_server_first as 'client_sync.settings.home.add_server_first' };
export { msg_client_sync_settings_home_choose_prompt as 'client_sync.settings.home.choose_prompt' };
export { msg_client_sync_settings_home_no_capable_server as 'client_sync.settings.home.no_capable_server' };
export { msg_client_sync_settings_sync_local as 'client_sync.settings.sync.local' };
export { msg_client_sync_settings_sync_loading as 'client_sync.settings.sync.loading' };
export { msg_client_sync_settings_sync_synced as 'client_sync.settings.sync.synced' };
export { msg_client_sync_settings_sync_unavailable as 'client_sync.settings.sync.unavailable' };
export { msg_client_sync_settings_sync_error as 'client_sync.settings.sync.error' };
