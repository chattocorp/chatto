...
- [ExternalIdentityAuthService](/reference/connectrpc-api/external-identity-auth/) - Capability-token external identity authentication RPCs.
...
- [MessageService](/reference/connectrpc-api/messages/) - Message creation, editing, deletion, permalink, reaction, link-preview, and attachment RPCs.
...
- [ServerService](/reference/connectrpc-api/server/) - Authenticated server profile and runtime configuration RPCs.
