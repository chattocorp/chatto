...
- `chatto.realtime.v1.RealtimeEvent.event` is the public realtime union. Its
  members reuse canonical EVT and live payload messages with the same field
  numbers. The union selects public variants, and field-surface options select
  public payload fields. Do not publish the complete core Event union.
