...
Positions between these labels smoothly blend the processing settings. At
**AWESOME**, the slider becomes an animated rainbow. If your system prefers
reduced motion, the rainbow stays still.
