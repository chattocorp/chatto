 ...
 *
 * @generated from message chatto.app.v1.AuthProvider
 */
export class AuthProvider extends Message<AuthProvider> {
  ...
  static readonly typeName = "chatto.app.v1.AuthProvider";
 ...
 *
 * @generated from message chatto.app.v1.GetServerRequest
 */
export class GetServerRequest extends Message<GetServerRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetServerRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 * initial server view.
 *
 * @generated from message chatto.app.v1.GetServerResponse
 */
export class GetServerResponse extends Message<GetServerResponse> {
   ...
   *
   * @generated from field: repeated chatto.app.v1.AuthProvider auth_providers = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetServerResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
