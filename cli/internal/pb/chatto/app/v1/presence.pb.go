...
// 	protoc        (unknown)
// source: chatto/app/v1/presence.proto
...
func (PresenceStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_app_v1_presence_proto_enumTypes[0].Descriptor()
}

func (PresenceStatus) Type() protoreflect.EnumType {
	return &file_chatto_app_v1_presence_proto_enumTypes[0]
}
...
func (PresenceStatus) EnumDescriptor() ([]byte, []int) {
	return file_chatto_app_v1_presence_proto_rawDescGZIP(), []int{0}
}
...
type ReportPresenceRequest struct {
	...
	Status PresenceStatus `protobuf:"varint,1,opt,name=status,proto3,enum=chatto.app.v1.PresenceStatus" json:"status,omitempty"`
...
func (x *ReportPresenceRequest) Reset() {
	*x = ReportPresenceRequest{}
	mi := &file_chatto_app_v1_presence_proto_msgTypes[0]
...
func (x *ReportPresenceResponse) Reset() {
	*x = ReportPresenceResponse{}
	mi := &file_chatto_app_v1_presence_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportPresenceResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_presence_proto_rawDescGZIP(), []int{1}
}
...
var File_chatto_app_v1_presence_proto protoreflect.FileDescriptor

const file_chatto_app_v1_presence_proto_rawDesc = "" +
	"\n" +
	"\x1cchatto/app/v1/presence.proto\x12\rchatto.app.v1\"s\n" +
	"\x15ReportPresenceRequest\x125\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1d.chatto.app.v1.PresenceStatusR\x06status\x12#\n" +
	"\ruser_selected\x18\x02 \x01(\bR\fuserSelected\"O\n" +
	"\x16ReportPresenceResponse\x125\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1d.chatto.app.v1.PresenceStatusR\x06status*\x8b\x01\n" +
	...
	"\x0eReportPresence\x12$.chatto.app.v1.ReportPresenceRequest\x1a%.chatto.app.v1.ReportPresenceResponseB\xa9\x01\n" +
	"\x11com.chatto.app.v1B\rPresenceProtoP\x01Z/hmans.de/chatto/internal/pb/chatto/app/v1;appv1\xa2\x02\x03CAX\xaa\x02\rChatto.App.V1\xca\x02\rChatto\\App\\V1\xe2\x02\x19Chatto\\App\\V1\\GPBMetadata\xea\x02\x0fChatto::App::V1b\x06proto3"

var (
	file_chatto_app_v1_presence_proto_rawDescOnce sync.Once
	file_chatto_app_v1_presence_proto_rawDescData []byte
)

func file_chatto_app_v1_presence_proto_rawDescGZIP() []byte {
	file_chatto_app_v1_presence_proto_rawDescOnce.Do(func() {
		file_chatto_app_v1_presence_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_app_v1_presence_proto_rawDesc), len(file_chatto_app_v1_presence_proto_rawDesc)))
	})
	return file_chatto_app_v1_presence_proto_rawDescData
}

var file_chatto_app_v1_presence_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_chatto_app_v1_presence_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_chatto_app_v1_presence_proto_goTypes = []any{
	(PresenceStatus)(0),            // 0: chatto.app.v1.PresenceStatus
	(*ReportPresenceRequest)(nil),  // 1: chatto.app.v1.ReportPresenceRequest
	(*ReportPresenceResponse)(nil), // 2: chatto.app.v1.ReportPresenceResponse
}
var file_chatto_app_v1_presence_proto_depIdxs = []int32{
	0, // 0: chatto.app.v1.ReportPresenceRequest.status:type_name -> chatto.app.v1.PresenceStatus
	0, // 1: chatto.app.v1.ReportPresenceResponse.status:type_name -> chatto.app.v1.PresenceStatus
	1, // 2: chatto.app.v1.PresenceService.ReportPresence:input_type -> chatto.app.v1.ReportPresenceRequest
	2, // 3: chatto.app.v1.PresenceService.ReportPresence:output_type -> chatto.app.v1.ReportPresenceResponse
...
func init() { file_chatto_app_v1_presence_proto_init() }
func file_chatto_app_v1_presence_proto_init() {
	if File_chatto_app_v1_presence_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chatto_app_v1_presence_proto_rawDesc), len(file_chatto_app_v1_presence_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chatto_app_v1_presence_proto_goTypes,
		DependencyIndexes: file_chatto_app_v1_presence_proto_depIdxs,
		EnumInfos:         file_chatto_app_v1_presence_proto_enumTypes,
		MessageInfos:      file_chatto_app_v1_presence_proto_msgTypes,
	}.Build()
	File_chatto_app_v1_presence_proto = out.File
	file_chatto_app_v1_presence_proto_goTypes = nil
	file_chatto_app_v1_presence_proto_depIdxs = nil
}
