...
const (
	...
	ServerStateServiceName = "chatto.app.v1.ServerStateService"
)
...
const (
	...
	// GetServerState RPC.
	ServerStateServiceGetServerStateProcedure = "/chatto.app.v1.ServerStateService/GetServerState"
	...
	ServerStateServiceUpdateServerConfigProcedure = "/chatto.app.v1.ServerStateService/UpdateServerConfig"
	// ServerStateServiceUploadServerLogoProcedure is the fully-qualified name of the
	// ServerStateService's UploadServerLogo RPC.
	ServerStateServiceUploadServerLogoProcedure = "/chatto.app.v1.ServerStateService/UploadServerLogo"
	// ServerStateServiceDeleteServerLogoProcedure is the fully-qualified name of the
	// ServerStateService's DeleteServerLogo RPC.
	ServerStateServiceDeleteServerLogoProcedure = "/chatto.app.v1.ServerStateService/DeleteServerLogo"
	...
	ServerStateServiceUploadServerBannerProcedure = "/chatto.app.v1.ServerStateService/UploadServerBanner"
	...
	ServerStateServiceDeleteServerBannerProcedure = "/chatto.app.v1.ServerStateService/DeleteServerBanner"
	...
	ServerStateServiceGetServerSecurityConfigProcedure = "/chatto.app.v1.ServerStateService/GetServerSecurityConfig"
	...
	ServerStateServiceUpdateBlockedUsernamesProcedure = "/chatto.app.v1.ServerStateService/UpdateBlockedUsernames"
)

// ServerStateServiceClient is a client for the chatto.app.v1.ServerStateService service.
...
// NewServerStateServiceClient constructs a client for the chatto.app.v1.ServerStateService service.
...
func NewServerStateServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ServerStateServiceClient {
	...
	serverStateServiceMethods := v1.File_chatto_app_v1_server_state_proto.Services().ByName("ServerStateService").Methods()
...
// GetServerState calls chatto.app.v1.ServerStateService.GetServerState.
...
// UpdateServerConfig calls chatto.app.v1.ServerStateService.UpdateServerConfig.
...
// UploadServerLogo calls chatto.app.v1.ServerStateService.UploadServerLogo.
...
// DeleteServerLogo calls chatto.app.v1.ServerStateService.DeleteServerLogo.
...
// UploadServerBanner calls chatto.app.v1.ServerStateService.UploadServerBanner.
...
// DeleteServerBanner calls chatto.app.v1.ServerStateService.DeleteServerBanner.
...
// GetServerSecurityConfig calls chatto.app.v1.ServerStateService.GetServerSecurityConfig.
...
// UpdateBlockedUsernames calls chatto.app.v1.ServerStateService.UpdateBlockedUsernames.
...
// ServerStateServiceHandler is an implementation of the chatto.app.v1.ServerStateService service.
...
func NewServerStateServiceHandler(svc ServerStateServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.ServerStateService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServerStateServiceHandler) GetServerState(context.Context, *connect.Request[v1.GetServerStateRequest]) (*connect.Response[v1.GetServerStateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.GetServerState is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) UpdateServerConfig(context.Context, *connect.Request[v1.UpdateServerConfigRequest]) (*connect.Response[v1.UpdateServerConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.UpdateServerConfig is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) UploadServerLogo(context.Context, *connect.Request[v1.UploadServerLogoRequest]) (*connect.Response[v1.UploadServerLogoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.UploadServerLogo is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) DeleteServerLogo(context.Context, *connect.Request[v1.DeleteServerLogoRequest]) (*connect.Response[v1.DeleteServerLogoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.DeleteServerLogo is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) UploadServerBanner(context.Context, *connect.Request[v1.UploadServerBannerRequest]) (*connect.Response[v1.UploadServerBannerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.UploadServerBanner is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) DeleteServerBanner(context.Context, *connect.Request[v1.DeleteServerBannerRequest]) (*connect.Response[v1.DeleteServerBannerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.DeleteServerBanner is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) GetServerSecurityConfig(context.Context, *connect.Request[v1.GetServerSecurityConfigRequest]) (*connect.Response[v1.GetServerSecurityConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.GetServerSecurityConfig is not implemented"))
}
...
func (UnimplementedServerStateServiceHandler) UpdateBlockedUsernames(context.Context, *connect.Request[v1.UpdateBlockedUsernamesRequest]) (*connect.Response[v1.UpdateBlockedUsernamesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ServerStateService.UpdateBlockedUsernames is not implemented"))
}
