...
<a id="chatto-api-v1-EffectivePolicies"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window_seconds` | `int32` | Maximum message age in seconds for author edits. Zero disables author edits. Users with message.manage remain unrestricted by this window. |

<a id="chatto-api-v1-EffectivePolicySource"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `scope` | [`PolicySourceScope`](#chatto-api-v1-PolicySourceScope) | No field description provided. |
| `scope_id` | `string` | Resource ID for room-group and room sources. Empty for product and server. |

<a id="chatto-api-v1-EffectivePolicySources"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window` | [`EffectivePolicySource`](#chatto-api-v1-EffectivePolicySource) | No field description provided. |
...
| `policies` | [`EffectivePolicies`](#chatto-api-v1-EffectivePolicies) | Effective runtime policies for this room and viewer. |
...
<a id="chatto-admin-v1-PolicyConfiguration"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `scope` | [`PolicyScope`](#chatto-admin-v1-PolicyScope) | No field description provided. |
| `overrides` | [`PolicyOverrides`](#chatto-admin-v1-PolicyOverrides) | No field description provided. |
| `effective` | `chatto.api.v1.EffectivePolicies` | No field description provided. |
| `sources` | `chatto.api.v1.EffectivePolicySources` | No field description provided. |

<a id="chatto-admin-v1-PolicyOverrides"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window_seconds` | `optional int32` | Maximum message age in seconds for author edits. Zero disables author edits. Absence means inherit. Maximum: 30 days. |

<a id="chatto-admin-v1-PolicyScope"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `scope.server` | `bool` | Server scope. Must be true when selected. |
| `scope.room_group_id` | `string` | Room-group scope. |
| `scope.room_id` | `string` | Channel-room scope. |
...
<a id="chatto-api-v1-PolicySourceScope"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `POLICY_SOURCE_SCOPE_UNSPECIFIED` | `0` | No value description provided. |
| `POLICY_SOURCE_SCOPE_PRODUCT_DEFAULT` | `1` | No value description provided. |
| `POLICY_SOURCE_SCOPE_SERVER` | `2` | No value description provided. |
| `POLICY_SOURCE_SCOPE_ROOM_GROUP` | `3` | No value description provided. |
| `POLICY_SOURCE_SCOPE_ROOM` | `4` | No value description provided. |
