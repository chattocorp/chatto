...
- [ExternalIdentityFlowService](/reference/connectrpc-api/external-identity-flows/) - Capability-token external identity confirmation RPCs.
...
- [MessageService](/reference/connectrpc-api/messages/) - Message creation, editing, deletion, link-preview, attachment, and typing RPCs.
- [MyAccountService](/reference/connectrpc-api/account/) - Self-service account, profile, avatar, presence, status, and settings RPCs for the authenticated user.
...
- [RoomMemberService](/reference/connectrpc-api/room-members/) - Room-scoped member directory RPCs.
...
- [ServerMemberService](/reference/connectrpc-api/server-members/) - Server-scoped member directory RPCs.
