...
export type Mutation = {
  ...
  /** Create an external sidebar link inside a room group. Requires `role.manage`. */
  ...
  /** Delete an external sidebar link. Requires `role.manage`. */
  ...
  /** Move an external sidebar link into another room group. Requires `role.manage`. */
  ...
  /** Update an external sidebar link. Requires `role.manage`. */
