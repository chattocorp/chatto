...
export type GetRoomQuery = { __typename?: 'Query', room?: { __typename?: 'Room', id: string, name: string, type: RoomType, isUniversal: boolean, viewerCanPostMessage: boolean, viewerCanPostInThread: boolean, viewerCanAttach: boolean, viewerCanReact: boolean, viewerCanManageOthersMessage: boolean, viewerCanEchoMessage: boolean, viewerCanManageRoom: boolean, viewerCanBanRoomMembers: boolean } | null, server: { __typename?: 'Server', viewerCanManageRooms: boolean, profile: { __typename?: 'ServerProfile', name: string } } };
