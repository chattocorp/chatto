...
const (
	...
	VoiceCallServiceName = "chatto.app.v1.VoiceCallService"
)
...
const (
	...
	VoiceCallServiceListActiveCallRoomsProcedure = "/chatto.app.v1.VoiceCallService/ListActiveCallRooms"
	...
	VoiceCallServiceListCallParticipantsProcedure = "/chatto.app.v1.VoiceCallService/ListCallParticipants"
	// VoiceCallServiceJoinCallProcedure is the fully-qualified name of the VoiceCallService's JoinCall
	// RPC.
	VoiceCallServiceJoinCallProcedure = "/chatto.app.v1.VoiceCallService/JoinCall"
	// VoiceCallServiceGetCallTokenProcedure is the fully-qualified name of the VoiceCallService's
	// GetCallToken RPC.
	VoiceCallServiceGetCallTokenProcedure = "/chatto.app.v1.VoiceCallService/GetCallToken"
	// VoiceCallServiceLeaveCallProcedure is the fully-qualified name of the VoiceCallService's
	// LeaveCall RPC.
	VoiceCallServiceLeaveCallProcedure = "/chatto.app.v1.VoiceCallService/LeaveCall"
)

// VoiceCallServiceClient is a client for the chatto.app.v1.VoiceCallService service.
...
// NewVoiceCallServiceClient constructs a client for the chatto.app.v1.VoiceCallService service. By
...
func NewVoiceCallServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VoiceCallServiceClient {
	...
	voiceCallServiceMethods := v1.File_chatto_app_v1_voice_calls_proto.Services().ByName("VoiceCallService").Methods()
...
// ListActiveCallRooms calls chatto.app.v1.VoiceCallService.ListActiveCallRooms.
...
// ListCallParticipants calls chatto.app.v1.VoiceCallService.ListCallParticipants.
...
// JoinCall calls chatto.app.v1.VoiceCallService.JoinCall.
...
// GetCallToken calls chatto.app.v1.VoiceCallService.GetCallToken.
...
// LeaveCall calls chatto.app.v1.VoiceCallService.LeaveCall.
...
// VoiceCallServiceHandler is an implementation of the chatto.app.v1.VoiceCallService service.
...
func NewVoiceCallServiceHandler(svc VoiceCallServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.VoiceCallService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVoiceCallServiceHandler) ListActiveCallRooms(context.Context, *connect.Request[v1.ListActiveCallRoomsRequest]) (*connect.Response[v1.ListActiveCallRoomsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.VoiceCallService.ListActiveCallRooms is not implemented"))
}
...
func (UnimplementedVoiceCallServiceHandler) ListCallParticipants(context.Context, *connect.Request[v1.ListCallParticipantsRequest]) (*connect.Response[v1.ListCallParticipantsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.VoiceCallService.ListCallParticipants is not implemented"))
}
...
func (UnimplementedVoiceCallServiceHandler) JoinCall(context.Context, *connect.Request[v1.JoinCallRequest]) (*connect.Response[v1.JoinCallResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.VoiceCallService.JoinCall is not implemented"))
}
...
func (UnimplementedVoiceCallServiceHandler) GetCallToken(context.Context, *connect.Request[v1.GetCallTokenRequest]) (*connect.Response[v1.GetCallTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.VoiceCallService.GetCallToken is not implemented"))
}
...
func (UnimplementedVoiceCallServiceHandler) LeaveCall(context.Context, *connect.Request[v1.LeaveCallRequest]) (*connect.Response[v1.LeaveCallResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.VoiceCallService.LeaveCall is not implemented"))
}
