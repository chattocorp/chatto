...
[![License: AGPL-3.0-or-later with Apache-2.0 exceptions](https://img.shields.io/badge/license-AGPL--3.0--or--later%20with%20Apache--2.0%20exceptions-blue.svg)](LICENSE.md)
...
Chatto is licensed under the
[GNU Affero General Public License v3.0 or later](LICENSE-AGPL)
(`AGPL-3.0-or-later`) by default, with machine-readable SPDX metadata for the
...
[LICENSE-APACHE](LICENSE-APACHE), and [LICENSES/](LICENSES/). The
`chatto license` command prints the AGPL-3.0-or-later license for the Chatto
server/CLI artifact.
The top-level [LICENSE](LICENSE) file is a mixed-license notice, not a
single-license grant for the whole repository.
