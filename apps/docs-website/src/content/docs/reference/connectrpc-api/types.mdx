...
| `ROOM_THREADING_MODE_DISABLED` | `4` | New threads and thread replies are rejected. Existing threads remain readable and ordinary in-room reply attribution remains available. |
