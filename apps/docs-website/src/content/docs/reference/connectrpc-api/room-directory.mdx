...
rooms visible through membership or room.list. DM rooms require membership
and message.read; empty DM conversations are omitted. Results are returned
as a finite navigation snapshot.
