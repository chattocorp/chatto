...
// 	protoc        (unknown)
// source: chatto/core/evt/v1/asset_events.proto
...
func (AssetDerivativeRole) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_evt_v1_asset_events_proto_enumTypes[0].Descriptor()
}

func (AssetDerivativeRole) Type() protoreflect.EnumType {
	return &file_chatto_core_evt_v1_asset_events_proto_enumTypes[0]
}
...
func (AssetDerivativeRole) EnumDescriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_asset_events_proto_rawDescGZIP(), []int{0}
}
...
func (AssetProcessingFailureCode) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_evt_v1_asset_events_proto_enumTypes[1].Descriptor()
}

func (AssetProcessingFailureCode) Type() protoreflect.EnumType {
	return &file_chatto_core_evt_v1_asset_events_proto_enumTypes[1]
}
...
func (AssetProcessingFailureCode) EnumDescriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_asset_events_proto_rawDescGZIP(), []int{1}
}
...
type AssetCreatedEvent struct {
	...
	DerivativeRole AssetDerivativeRole `protobuf:"varint,6,opt,name=derivative_role,json=derivativeRole,proto3,enum=chatto.core.evt.v1.AssetDerivativeRole" json:"derivative_role,omitempty"`
...
func (x *AssetCreatedEvent) Reset() {
	*x = AssetCreatedEvent{}
	mi := &file_chatto_core_evt_v1_asset_events_proto_msgTypes[0]
...
func (x *AssetDeletedEvent) Reset() {
	*x = AssetDeletedEvent{}
	mi := &file_chatto_core_evt_v1_asset_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AssetAttachedEvent) Reset() {
	*x = AssetAttachedEvent{}
	mi := &file_chatto_core_evt_v1_asset_events_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetAttachedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_asset_events_proto_rawDescGZIP(), []int{2}
}
...
type AssetProcessingFailedEvent struct {
	state       protoimpl.MessageState     `protogen:"open.v1"`
	AssetId     string                     `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`
	FailureCode AssetProcessingFailureCode `protobuf:"varint,2,opt,name=failure_code,json=failureCode,proto3,enum=chatto.core.evt.v1.AssetProcessingFailureCode" json:"failure_code,omitempty"`
	// Event id of the owning message, stamped at publish time (see
	// AssetProcessingStartedEvent.message_event_id). Empty only for one-shot
	// migration events.
	MessageEventId string `protobuf:"bytes,3,opt,name=message_event_id,json=messageEventId,proto3" json:"message_event_id,omitempty"`
...
var File_chatto_core_evt_v1_asset_events_proto protoreflect.FileDescriptor
...
const file_chatto_core_evt_v1_asset_events_proto_rawDesc = "" +
	...
	",ASSET_PROCESSING_FAILURE_CODE_SOURCE_MISSING\x10\x02B\xcb\x01\n" +
	"\x16com.chatto.core.evt.v1B\x10AssetEventsProtoP\x01Z4hmans.de/chatto/internal/pb/chatto/core/evt/v1;evtv1\xa2\x02\x03CCE\xaa\x02\x12Chatto.Core.Evt.V1\xca\x02\x12Chatto\\Core\\Evt\\V1\xe2\x02\x1eChatto\\Core\\Evt\\V1\\GPBMetadata\xea\x02\x15Chatto::Core::Evt::V1b\x06proto3"

var (
	file_chatto_core_evt_v1_asset_events_proto_rawDescOnce sync.Once
	file_chatto_core_evt_v1_asset_events_proto_rawDescData []byte
)

func file_chatto_core_evt_v1_asset_events_proto_rawDescGZIP() []byte {
	file_chatto_core_evt_v1_asset_events_proto_rawDescOnce.Do(func() {
		file_chatto_core_evt_v1_asset_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_core_evt_v1_asset_events_proto_rawDesc), len(file_chatto_core_evt_v1_asset_events_proto_rawDesc)))
	})
	return file_chatto_core_evt_v1_asset_events_proto_rawDescData
}
...
func file_chatto_core_evt_v1_asset_events_proto_init() {
	if File_chatto_core_evt_v1_asset_events_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_chatto_core_evt_v1_asset_events_proto_goTypes,
		DependencyIndexes: file_chatto_core_evt_v1_asset_events_proto_depIdxs,
		EnumInfos:         file_chatto_core_evt_v1_asset_events_proto_enumTypes,
		MessageInfos:      file_chatto_core_evt_v1_asset_events_proto_msgTypes,
	}.Build()
	File_chatto_core_evt_v1_asset_events_proto = out.File
	file_chatto_core_evt_v1_asset_events_proto_goTypes = nil
	file_chatto_core_evt_v1_asset_events_proto_depIdxs = nil
}
