...
| `testimonial` | `optional string` | Optional public explanation of why this server is recommended. |
...
| `testimonial` | `optional string` | New testimonial. Omit this field to keep the current value. Send an empty value to clear it. |
