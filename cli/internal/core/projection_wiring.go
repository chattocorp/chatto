...
func initializeCoreProjections(
	...
	contentView := newServerContentView(
		newServerContentComponent(projectionsnapshot.ProjectionRoomDirectoryKey, roomDirectory),
		newServerContentComponent(projectionsnapshot.ProjectionServerConfigKey, serverConfig),
		newServerContentComponent(projectionsnapshot.ProjectionRoomGroupLayoutKey, roomGroupLayout),
		newServerContentComponent(projectionsnapshot.ProjectionRoomTimelineKey, roomTimeline),
		newServerContentComponent(projectionsnapshot.ProjectionCallStateKey, callState),
		newServerContentComponent(projectionsnapshot.ProjectionAssetsKey, assets),
		newServerContentComponent(projectionsnapshot.ProjectionThreadsKey, threads),
		newServerContentComponent(projectionsnapshot.ProjectionReactionsKey, reactions),
		newServerContentComponent(projectionsnapshot.ProjectionUsersKey, users),
		newServerContentComponent(projectionsnapshot.ProjectionContentKeysKey, contentKeys),
		newServerContentComponent(projectionsnapshot.ProjectionRBACKey, rbac),
		newServerContentComponent(projectionsnapshot.ProjectionMentionablesKey, mentionables),
	)
