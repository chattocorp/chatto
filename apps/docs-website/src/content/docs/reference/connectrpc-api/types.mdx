...
| Field | Type | Description |
| --- | --- | --- |
| `category` | [`NotificationPreferenceCategory`](#chatto-api-v1-NotificationPreferenceCategory) | Preference category controlled by this row. |
| `override` | optional [`NotificationDeliveryMode`](#chatto-api-v1-NotificationDeliveryMode) | Explicit override at the requested scope. Absence means Inherit. |
| `effective` | [`NotificationDeliveryMode`](#chatto-api-v1-NotificationDeliveryMode) | Effective mode after applying product, server, and room inheritance. |
...
<a id="chatto-api-v1-NotificationPreferenceCategory"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `NOTIFICATION_PREFERENCE_CATEGORY_UNSPECIFIED` | `0` | No cause was specified. This value is not valid in preference writes. |
| `NOTIFICATION_PREFERENCE_CATEGORY_DIRECT_MESSAGE` | `1` | A message was posted in a direct-message conversation. |
| `NOTIFICATION_PREFERENCE_CATEGORY_DIRECT_MENTION` | `2` | The viewer's username was mentioned directly. |
| `NOTIFICATION_PREFERENCE_CATEGORY_REPLY` | `3` | Activity replied directly to the viewer's message. |
| `NOTIFICATION_PREFERENCE_CATEGORY_ROLE_MENTION` | `4` | A role held by the viewer was mentioned. |
| `NOTIFICATION_PREFERENCE_CATEGORY_HERE` | `5` | An `@here` mention included the viewer. |
| `NOTIFICATION_PREFERENCE_CATEGORY_ALL` | `6` | An `@all` mention included the viewer. |
| `NOTIFICATION_PREFERENCE_CATEGORY_FOLLOWED_THREAD` | `7` | New activity appeared in a thread followed by the viewer. |
| `NOTIFICATION_PREFERENCE_CATEGORY_FOLLOWED_ROOM` | `8` | New activity appeared in a room followed by the viewer. |
| `NOTIFICATION_PREFERENCE_CATEGORY_REACTION` | `9` | Someone reacted to the viewer's message. |
