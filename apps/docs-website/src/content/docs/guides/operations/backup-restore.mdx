...
| [Bundled Bleve search index](/guides/operations/bundled-search-provider/) | Privileged plaintext-derived local cache. Protect its volume separately or rebuild it from retained `EVT` history. |
