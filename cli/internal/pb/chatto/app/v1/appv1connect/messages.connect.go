...
const (
	...
	MessageServiceName = "chatto.app.v1.MessageService"
)
...
const (
	...
	// PostMessage RPC.
	MessageServicePostMessageProcedure = "/chatto.app.v1.MessageService/PostMessage"
	// MessageServiceUpdateMessageProcedure is the fully-qualified name of the MessageService's
	// UpdateMessage RPC.
	MessageServiceUpdateMessageProcedure = "/chatto.app.v1.MessageService/UpdateMessage"
	// MessageServiceDeleteMessageProcedure is the fully-qualified name of the MessageService's
	// DeleteMessage RPC.
	MessageServiceDeleteMessageProcedure = "/chatto.app.v1.MessageService/DeleteMessage"
	// MessageServiceDeleteAttachmentProcedure is the fully-qualified name of the MessageService's
	// DeleteAttachment RPC.
	MessageServiceDeleteAttachmentProcedure = "/chatto.app.v1.MessageService/DeleteAttachment"
	// MessageServiceDeleteLinkPreviewProcedure is the fully-qualified name of the MessageService's
	// DeleteLinkPreview RPC.
	MessageServiceDeleteLinkPreviewProcedure = "/chatto.app.v1.MessageService/DeleteLinkPreview"
	// MessageServiceSendTypingIndicatorProcedure is the fully-qualified name of the MessageService's
	// SendTypingIndicator RPC.
	MessageServiceSendTypingIndicatorProcedure = "/chatto.app.v1.MessageService/SendTypingIndicator"
)

// MessageServiceClient is a client for the chatto.app.v1.MessageService service.
...
// NewMessageServiceClient constructs a client for the chatto.app.v1.MessageService service. By
...
func NewMessageServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MessageServiceClient {
	...
	messageServiceMethods := v1.File_chatto_app_v1_messages_proto.Services().ByName("MessageService").Methods()
...
// PostMessage calls chatto.app.v1.MessageService.PostMessage.
...
// UpdateMessage calls chatto.app.v1.MessageService.UpdateMessage.
...
// DeleteMessage calls chatto.app.v1.MessageService.DeleteMessage.
...
// DeleteAttachment calls chatto.app.v1.MessageService.DeleteAttachment.
...
// DeleteLinkPreview calls chatto.app.v1.MessageService.DeleteLinkPreview.
...
// SendTypingIndicator calls chatto.app.v1.MessageService.SendTypingIndicator.
...
// MessageServiceHandler is an implementation of the chatto.app.v1.MessageService service.
...
func NewMessageServiceHandler(svc MessageServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.MessageService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMessageServiceHandler) PostMessage(context.Context, *connect.Request[v1.PostMessageRequest]) (*connect.Response[v1.PostMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.PostMessage is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) UpdateMessage(context.Context, *connect.Request[v1.UpdateMessageRequest]) (*connect.Response[v1.UpdateMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.UpdateMessage is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) DeleteMessage(context.Context, *connect.Request[v1.DeleteMessageRequest]) (*connect.Response[v1.DeleteMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.DeleteMessage is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) DeleteAttachment(context.Context, *connect.Request[v1.DeleteAttachmentRequest]) (*connect.Response[v1.DeleteAttachmentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.DeleteAttachment is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) DeleteLinkPreview(context.Context, *connect.Request[v1.DeleteLinkPreviewRequest]) (*connect.Response[v1.DeleteLinkPreviewResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.DeleteLinkPreview is not implemented"))
}
...
func (UnimplementedMessageServiceHandler) SendTypingIndicator(context.Context, *connect.Request[v1.SendTypingIndicatorRequest]) (*connect.Response[v1.SendTypingIndicatorResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.MessageService.SendTypingIndicator is not implemented"))
}
