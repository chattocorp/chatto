...
const (
	...
	RoomDirectoryServiceName = "chatto.app.v1.RoomDirectoryService"
)
...
const (
	...
	// ListRooms RPC.
	RoomDirectoryServiceListRoomsProcedure = "/chatto.app.v1.RoomDirectoryService/ListRooms"
	// RoomDirectoryServiceListRoomGroupsProcedure is the fully-qualified name of the
	// RoomDirectoryService's ListRoomGroups RPC.
	RoomDirectoryServiceListRoomGroupsProcedure = "/chatto.app.v1.RoomDirectoryService/ListRoomGroups"
	// RoomDirectoryServiceGetRoomProcedure is the fully-qualified name of the RoomDirectoryService's
	// GetRoom RPC.
	RoomDirectoryServiceGetRoomProcedure = "/chatto.app.v1.RoomDirectoryService/GetRoom"
	// RoomDirectoryServiceJoinGroupProcedure is the fully-qualified name of the RoomDirectoryService's
	// JoinGroup RPC.
	RoomDirectoryServiceJoinGroupProcedure = "/chatto.app.v1.RoomDirectoryService/JoinGroup"
)

// RoomDirectoryServiceClient is a client for the chatto.app.v1.RoomDirectoryService service.
...
// NewRoomDirectoryServiceClient constructs a client for the chatto.app.v1.RoomDirectoryService
...
func NewRoomDirectoryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RoomDirectoryServiceClient {
	...
	roomDirectoryServiceMethods := v1.File_chatto_app_v1_room_directory_proto.Services().ByName("RoomDirectoryService").Methods()
...
// ListRooms calls chatto.app.v1.RoomDirectoryService.ListRooms.
...
// ListRoomGroups calls chatto.app.v1.RoomDirectoryService.ListRoomGroups.
...
// GetRoom calls chatto.app.v1.RoomDirectoryService.GetRoom.
...
// JoinGroup calls chatto.app.v1.RoomDirectoryService.JoinGroup.
...
// RoomDirectoryServiceHandler is an implementation of the chatto.app.v1.RoomDirectoryService
// service.
...
func NewRoomDirectoryServiceHandler(svc RoomDirectoryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.RoomDirectoryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRoomDirectoryServiceHandler) ListRooms(context.Context, *connect.Request[v1.ListRoomsRequest]) (*connect.Response[v1.ListRoomsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomDirectoryService.ListRooms is not implemented"))
}
...
func (UnimplementedRoomDirectoryServiceHandler) ListRoomGroups(context.Context, *connect.Request[v1.ListRoomGroupsRequest]) (*connect.Response[v1.ListRoomGroupsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomDirectoryService.ListRoomGroups is not implemented"))
}
...
func (UnimplementedRoomDirectoryServiceHandler) GetRoom(context.Context, *connect.Request[v1.GetRoomRequest]) (*connect.Response[v1.GetRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomDirectoryService.GetRoom is not implemented"))
}
...
func (UnimplementedRoomDirectoryServiceHandler) JoinGroup(context.Context, *connect.Request[v1.JoinGroupRequest]) (*connect.Response[v1.JoinGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomDirectoryService.JoinGroup is not implemented"))
}
