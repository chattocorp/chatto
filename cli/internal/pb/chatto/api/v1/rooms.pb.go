...
type RemoveBotThreadAccessRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RemoveBotThreadAccessRequest) Reset() {
	*x = RemoveBotThreadAccessRequest{}
	mi := &file_chatto_api_v1_rooms_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemoveBotThreadAccessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoveBotThreadAccessRequest) ProtoMessage() {}

func (x *RemoveBotThreadAccessRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chatto_api_v1_rooms_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemoveBotThreadAccessRequest.ProtoReflect.Descriptor instead.
func (*RemoveBotThreadAccessRequest) Descriptor() ([]byte, []int) {
	return file_chatto_api_v1_rooms_proto_rawDescGZIP(), []int{22}
}

func (x *RemoveBotThreadAccessRequest) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *RemoveBotThreadAccessRequest) GetThreadRootEventId() string {
	if x != nil {
...
func (x *RemoveBotThreadAccessRequest) GetBotId() string {
	if x != nil {
		return x.BotId
	}
	return ""
...
type RemoveBotThreadAccessResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RemoveBotThreadAccessResponse) Reset() {
	*x = RemoveBotThreadAccessResponse{}
	mi := &file_chatto_api_v1_rooms_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemoveBotThreadAccessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoveBotThreadAccessResponse) ProtoMessage() {}

func (x *RemoveBotThreadAccessResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chatto_api_v1_rooms_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemoveBotThreadAccessResponse.ProtoReflect.Descriptor instead.
func (*RemoveBotThreadAccessResponse) Descriptor() ([]byte, []int) {
	return file_chatto_api_v1_rooms_proto_rawDescGZIP(), []int{23}
}

func (x *RemoveBotThreadAccessResponse) GetRemoved() bool {
	if x != nil {
		return x.Removed
	}
	return false
...
const file_chatto_api_v1_rooms_proto_rawDesc = "" +
	...
	"\aremoved\x18\x01 \x01(\bR\aremoved\"\x9a\x01\n" +
	"\x1cRemoveBotThreadAccessRequest\x12 \n" +
	"\aroom_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06roomId\x128\n" +
	"\x14thread_root_event_id\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x11threadRootEventId\x12\x1e\n" +
	"\x06bot_id\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05botId\"9\n" +
	"\x1dRemoveBotThreadAccessResponse\x12\x18\n" +
	...
	"\fROOM_KIND_DM\x10\x022\xaa\x12\n" +
	"\vRoomService\x12Q\n" +
	"\n" +
	...
	"\fRemoveMember\x12\".chatto.api.v1.RemoveMemberRequest\x1a#.chatto.api.v1.RemoveMemberResponse\x12r\n" +
	"\x15RemoveBotThreadAccess\x12+.chatto.api.v1.RemoveBotThreadAccessRequest\x1a,.chatto.api.v1.RemoveBotThreadAccessResponse\x12K\n" +
...
var file_chatto_api_v1_rooms_proto_goTypes = []any{
	...
	(*RemoveBotThreadAccessRequest)(nil),  // 23: chatto.api.v1.RemoveBotThreadAccessRequest
	(*RemoveBotThreadAccessResponse)(nil), // 24: chatto.api.v1.RemoveBotThreadAccessResponse
	(*BanMemberRequest)(nil),              // 25: chatto.api.v1.BanMemberRequest
	(*BanMemberResponse)(nil),             // 26: chatto.api.v1.BanMemberResponse
	(*UnbanMemberRequest)(nil),            // 27: chatto.api.v1.UnbanMemberRequest
	(*UnbanMemberResponse)(nil),           // 28: chatto.api.v1.UnbanMemberResponse
	(*RoomBan)(nil),                       // 29: chatto.api.v1.RoomBan
	(*ListBansRequest)(nil),               // 30: chatto.api.v1.ListBansRequest
	(*ListBansResponse)(nil),              // 31: chatto.api.v1.ListBansResponse
	(*ListRoomAttachmentsRequest)(nil),    // 32: chatto.api.v1.ListRoomAttachmentsRequest
	(*ListRoomAttachmentsResponse)(nil),   // 33: chatto.api.v1.ListRoomAttachmentsResponse
	(*PinnedMessage)(nil),                 // 34: chatto.api.v1.PinnedMessage
	(*ListPinnedMessagesRequest)(nil),     // 35: chatto.api.v1.ListPinnedMessagesRequest
	(*ListPinnedMessagesResponse)(nil),    // 36: chatto.api.v1.ListPinnedMessagesResponse
...
var file_chatto_api_v1_rooms_proto_depIdxs = []int32{
	...
	29, // 16: chatto.api.v1.ListBansResponse.bans:type_name -> chatto.api.v1.RoomBan
	...
	34, // 24: chatto.api.v1.ListPinnedMessagesResponse.pinned_messages:type_name -> chatto.api.v1.PinnedMessage
	46, // 25: chatto.api.v1.ListPinnedMessagesResponse.page:type_name -> chatto.api.v1.PageInfo
	34, // 26: chatto.api.v1.CreatePinnedMessageResponse.pinned_message:type_name -> chatto.api.v1.PinnedMessage
	...
	50, // 35: chatto.api.v1.RoomService.ListMembers:input_type -> chatto.api.v1.ListRoomMembersRequest
	51, // 36: chatto.api.v1.RoomService.GetMember:input_type -> chatto.api.v1.GetRoomMemberRequest
	52, // 37: chatto.api.v1.RoomService.BatchGetMembers:input_type -> chatto.api.v1.BatchGetRoomMembersRequest
	...
	23, // 40: chatto.api.v1.RoomService.RemoveBotThreadAccess:input_type -> chatto.api.v1.RemoveBotThreadAccessRequest
	30, // 41: chatto.api.v1.RoomService.ListBans:input_type -> chatto.api.v1.ListBansRequest
	32, // 42: chatto.api.v1.RoomService.ListRoomAttachments:input_type -> chatto.api.v1.ListRoomAttachmentsRequest
	35, // 43: chatto.api.v1.RoomService.ListPinnedMessages:input_type -> chatto.api.v1.ListPinnedMessagesRequest
	37, // 44: chatto.api.v1.RoomService.CreatePinnedMessage:input_type -> chatto.api.v1.CreatePinnedMessageRequest
	39, // 45: chatto.api.v1.RoomService.DeletePinnedMessage:input_type -> chatto.api.v1.DeletePinnedMessageRequest
	41, // 46: chatto.api.v1.RoomService.UpdateTypingIndicator:input_type -> chatto.api.v1.UpdateTypingIndicatorRequest
	53, // 47: chatto.api.v1.RoomService.GetRoomEvents:input_type -> chatto.api.v1.GetRoomEventsRequest
	54, // 48: chatto.api.v1.RoomService.GetRoomEventsAround:input_type -> chatto.api.v1.GetRoomEventsAroundRequest
	55, // 49: chatto.api.v1.RoomService.MarkRoomAsRead:input_type -> chatto.api.v1.MarkRoomAsReadRequest
	25, // 50: chatto.api.v1.RoomService.BanMember:input_type -> chatto.api.v1.BanMemberRequest
	27, // 51: chatto.api.v1.RoomService.UnbanMember:input_type -> chatto.api.v1.UnbanMemberRequest
	4,  // 52: chatto.api.v1.RoomService.CreateRoom:output_type -> chatto.api.v1.CreateRoomResponse
	6,  // 53: chatto.api.v1.RoomService.UpdateRoom:output_type -> chatto.api.v1.UpdateRoomResponse
	8,  // 54: chatto.api.v1.RoomService.ArchiveRoom:output_type -> chatto.api.v1.ArchiveRoomResponse
	10, // 55: chatto.api.v1.RoomService.UnarchiveRoom:output_type -> chatto.api.v1.UnarchiveRoomResponse
	12, // 56: chatto.api.v1.RoomService.JoinRoom:output_type -> chatto.api.v1.JoinRoomResponse
	14, // 57: chatto.api.v1.RoomService.JoinRoomGroup:output_type -> chatto.api.v1.JoinRoomGroupResponse
	16, // 58: chatto.api.v1.RoomService.StartDM:output_type -> chatto.api.v1.StartDMResponse
	18, // 59: chatto.api.v1.RoomService.LeaveRoom:output_type -> chatto.api.v1.LeaveRoomResponse
	56, // 60: chatto.api.v1.RoomService.ListMembers:output_type -> chatto.api.v1.ListRoomMembersResponse
	57, // 61: chatto.api.v1.RoomService.GetMember:output_type -> chatto.api.v1.GetRoomMemberResponse
	58, // 62: chatto.api.v1.RoomService.BatchGetMembers:output_type -> chatto.api.v1.BatchGetRoomMembersResponse
	20, // 63: chatto.api.v1.RoomService.AddMember:output_type -> chatto.api.v1.AddMemberResponse
	22, // 64: chatto.api.v1.RoomService.RemoveMember:output_type -> chatto.api.v1.RemoveMemberResponse
	24, // 65: chatto.api.v1.RoomService.RemoveBotThreadAccess:output_type -> chatto.api.v1.RemoveBotThreadAccessResponse
	31, // 66: chatto.api.v1.RoomService.ListBans:output_type -> chatto.api.v1.ListBansResponse
	33, // 67: chatto.api.v1.RoomService.ListRoomAttachments:output_type -> chatto.api.v1.ListRoomAttachmentsResponse
	36, // 68: chatto.api.v1.RoomService.ListPinnedMessages:output_type -> chatto.api.v1.ListPinnedMessagesResponse
	38, // 69: chatto.api.v1.RoomService.CreatePinnedMessage:output_type -> chatto.api.v1.CreatePinnedMessageResponse
	40, // 70: chatto.api.v1.RoomService.DeletePinnedMessage:output_type -> chatto.api.v1.DeletePinnedMessageResponse
	42, // 71: chatto.api.v1.RoomService.UpdateTypingIndicator:output_type -> chatto.api.v1.UpdateTypingIndicatorResponse
	59, // 72: chatto.api.v1.RoomService.GetRoomEvents:output_type -> chatto.api.v1.GetRoomEventsResponse
	60, // 73: chatto.api.v1.RoomService.GetRoomEventsAround:output_type -> chatto.api.v1.GetRoomEventsAroundResponse
	61, // 74: chatto.api.v1.RoomService.MarkRoomAsRead:output_type -> chatto.api.v1.MarkRoomAsReadResponse
	26, // 75: chatto.api.v1.RoomService.BanMember:output_type -> chatto.api.v1.BanMemberResponse
	28, // 76: chatto.api.v1.RoomService.UnbanMember:output_type -> chatto.api.v1.UnbanMemberResponse
