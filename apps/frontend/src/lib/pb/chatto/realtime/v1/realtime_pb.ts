...
import { NotificationLevel } from "../../app/v1/notification_preferences_pb.js";

/**
 * Presence status delivered by the realtime stream.
 *
 * @generated from enum chatto.realtime.v1.RealtimePresenceStatus
 */
...
proto3.util.setEnumType(RealtimePresenceStatus, "chatto.realtime.v1.RealtimePresenceStatus", [
...
export class RealtimePresenceChangedEvent extends Message<RealtimePresenceChangedEvent> {
   ...
   *
   * @generated from field: chatto.realtime.v1.RealtimePresenceStatus status = 2;
   */
...
export class RealtimeNotificationLevelChangedEvent extends Message<RealtimeNotificationLevelChangedEvent> {
   ...
   *
   * @generated from field: chatto.app.v1.NotificationLevel level = 2;
   */
   ...
   *
   * @generated from field: chatto.app.v1.NotificationLevel effective_level = 3;
   */
