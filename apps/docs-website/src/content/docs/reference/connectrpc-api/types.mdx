...
| `target` | [`NotificationTarget`](#chatto-api-v1-NotificationTarget) | Typed resource or activity represented by this occurrence. |
...
<a id="chatto-api-v1-NotificationRoomMessageTarget"></a>

### NotificationRoomMessageTarget
...
| Field | Type | Description |
| --- | --- | --- |
| `kind.room_message` | [`NotificationRoomMessageTarget`](#chatto-api-v1-NotificationRoomMessageTarget) | Exact room-message destination. |
