...
func apiPresenceStatus(status string) realtimev1.RealtimePresenceStatus {
	switch status {
	case core.PresenceStatusOffline:
		return realtimev1.RealtimePresenceStatus_REALTIME_PRESENCE_STATUS_OFFLINE
	case core.PresenceStatusOnline:
		return realtimev1.RealtimePresenceStatus_REALTIME_PRESENCE_STATUS_ONLINE
	case core.PresenceStatusAway:
		return realtimev1.RealtimePresenceStatus_REALTIME_PRESENCE_STATUS_AWAY
	case core.PresenceStatusDoNotDisturb:
		return realtimev1.RealtimePresenceStatus_REALTIME_PRESENCE_STATUS_DO_NOT_DISTURB
	default:
		return realtimev1.RealtimePresenceStatus_REALTIME_PRESENCE_STATUS_UNSPECIFIED
	}
}

func apiNotificationLevel(level corev1.NotificationLevel) appv1.NotificationLevel {
	switch level {
...
func apiRealtimeTimeFormat(format corev1.TimeFormat) realtimev1.RealtimeTimeFormat {
	switch format {
