...
<a id="chatto-api-v1-ThreadSearchResult"></a>
...
| `matching_message` | [`Message`](#chatto-api-v1-Message) | Best current match in the selected order. Activity order uses the newest match. |
| `relevance_score` | `double` | Relevance score of matching_message. |
