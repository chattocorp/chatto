...
| Field | Type | Description |
| --- | --- | --- |
| `mode` | [`PresenceMode`](#chatto-api-v1-PresenceMode) | No field description provided. |
...
| Name | Number | Description |
| --- | --- | --- |
| `PRESENCE_MODE_UNSPECIFIED` | `0` | No value description provided. |
| `PRESENCE_MODE_ONLINE` | `1` | No value description provided. |
| `PRESENCE_MODE_AWAY` | `2` | No value description provided. |
| `PRESENCE_MODE_DO_NOT_DISTURB` | `3` | No value description provided. |
