...
| **Disabled** | New threads and thread replies are unavailable. Existing threads remain readable, and members can still use ordinary reply attribution in the room. |
