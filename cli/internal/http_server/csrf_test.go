...
func setupCSRFTestServer(t *testing.T) (*httptest.Server, *http.Client) {
	...
	router.POST(connectAPIPrefix+"/chatto.app.v1.ServerService/GetServer", func(c *gin.Context) {
...
func TestCSRFMiddleware(t *testing.T) {
	...
	t.Run("exempts cookie ConnectRPC POST", func(t *testing.T) {
		...
		resp, err := client.Post(server.URL+connectAPIPrefix+"/chatto.app.v1.ServerService/GetServer", "application/proto", strings.NewReader(""))
		if err != nil {
