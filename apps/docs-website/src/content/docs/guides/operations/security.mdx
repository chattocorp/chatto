...
whole renewable session. Deleting the stable record invalidates every access
generation immediately, even before their short-lived verifier records expire.
