...
// 	protoc        (unknown)
// source: chatto/app/v1/read_state.proto
...
func (x *MarkRoomAsReadRequest) Reset() {
	*x = MarkRoomAsReadRequest{}
	mi := &file_chatto_app_v1_read_state_proto_msgTypes[0]
...
func (*MarkRoomAsReadRequest) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_read_state_proto_rawDescGZIP(), []int{0}
}
...
func (x *MarkRoomAsReadResponse) Reset() {
	*x = MarkRoomAsReadResponse{}
	mi := &file_chatto_app_v1_read_state_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MarkRoomAsReadResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_read_state_proto_rawDescGZIP(), []int{1}
}
...
func (x *MarkThreadAsReadRequest) Reset() {
	*x = MarkThreadAsReadRequest{}
	mi := &file_chatto_app_v1_read_state_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MarkThreadAsReadRequest) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_read_state_proto_rawDescGZIP(), []int{2}
}
...
func (x *MarkThreadAsReadResponse) Reset() {
	*x = MarkThreadAsReadResponse{}
	mi := &file_chatto_app_v1_read_state_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MarkThreadAsReadResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_read_state_proto_rawDescGZIP(), []int{3}
}
...
var File_chatto_app_v1_read_state_proto protoreflect.FileDescriptor

const file_chatto_app_v1_read_state_proto_rawDesc = "" +
	"\n" +
	"\x1echatto/app/v1/read_state.proto\x12\rchatto.app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"^\n" +
	...
	"\x0eMarkRoomAsRead\x12$.chatto.app.v1.MarkRoomAsReadRequest\x1a%.chatto.app.v1.MarkRoomAsReadResponse\x12c\n" +
	"\x10MarkThreadAsRead\x12&.chatto.app.v1.MarkThreadAsReadRequest\x1a'.chatto.app.v1.MarkThreadAsReadResponseB\xaa\x01\n" +
	"\x11com.chatto.app.v1B\x0eReadStateProtoP\x01Z/hmans.de/chatto/internal/pb/chatto/app/v1;appv1\xa2\x02\x03CAX\xaa\x02\rChatto.App.V1\xca\x02\rChatto\\App\\V1\xe2\x02\x19Chatto\\App\\V1\\GPBMetadata\xea\x02\x0fChatto::App::V1b\x06proto3"

var (
	file_chatto_app_v1_read_state_proto_rawDescOnce sync.Once
	file_chatto_app_v1_read_state_proto_rawDescData []byte
)

func file_chatto_app_v1_read_state_proto_rawDescGZIP() []byte {
	file_chatto_app_v1_read_state_proto_rawDescOnce.Do(func() {
		file_chatto_app_v1_read_state_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_app_v1_read_state_proto_rawDesc), len(file_chatto_app_v1_read_state_proto_rawDesc)))
	})
	return file_chatto_app_v1_read_state_proto_rawDescData
}

var file_chatto_app_v1_read_state_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_chatto_app_v1_read_state_proto_goTypes = []any{
	(*MarkRoomAsReadRequest)(nil),    // 0: chatto.app.v1.MarkRoomAsReadRequest
	(*MarkRoomAsReadResponse)(nil),   // 1: chatto.app.v1.MarkRoomAsReadResponse
	(*MarkThreadAsReadRequest)(nil),  // 2: chatto.app.v1.MarkThreadAsReadRequest
	(*MarkThreadAsReadResponse)(nil), // 3: chatto.app.v1.MarkThreadAsReadResponse
	(*timestamppb.Timestamp)(nil),    // 4: google.protobuf.Timestamp
}
var file_chatto_app_v1_read_state_proto_depIdxs = []int32{
	4, // 0: chatto.app.v1.MarkRoomAsReadResponse.last_read_at:type_name -> google.protobuf.Timestamp
	4, // 1: chatto.app.v1.MarkRoomAsReadResponse.previous_last_read_at:type_name -> google.protobuf.Timestamp
	4, // 2: chatto.app.v1.MarkThreadAsReadResponse.previous_read_at:type_name -> google.protobuf.Timestamp
	0, // 3: chatto.app.v1.ReadStateService.MarkRoomAsRead:input_type -> chatto.app.v1.MarkRoomAsReadRequest
	2, // 4: chatto.app.v1.ReadStateService.MarkThreadAsRead:input_type -> chatto.app.v1.MarkThreadAsReadRequest
	1, // 5: chatto.app.v1.ReadStateService.MarkRoomAsRead:output_type -> chatto.app.v1.MarkRoomAsReadResponse
	3, // 6: chatto.app.v1.ReadStateService.MarkThreadAsRead:output_type -> chatto.app.v1.MarkThreadAsReadResponse
...
func init() { file_chatto_app_v1_read_state_proto_init() }
func file_chatto_app_v1_read_state_proto_init() {
	if File_chatto_app_v1_read_state_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chatto_app_v1_read_state_proto_rawDesc), len(file_chatto_app_v1_read_state_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chatto_app_v1_read_state_proto_goTypes,
		DependencyIndexes: file_chatto_app_v1_read_state_proto_depIdxs,
		MessageInfos:      file_chatto_app_v1_read_state_proto_msgTypes,
	}.Build()
	File_chatto_app_v1_read_state_proto = out.File
	file_chatto_app_v1_read_state_proto_goTypes = nil
	file_chatto_app_v1_read_state_proto_depIdxs = nil
}
