...
type RoomCreatedEvent struct {
	...
	ThreadingMode RoomThreadingMode `protobuf:"varint,7,opt,name=threading_mode,json=threadingMode,proto3,enum=chatto.core.v1.RoomThreadingMode" json:"threading_mode,omitempty"`
...
type RoomThreadingModeChangedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RoomId        string                 `protobuf:"bytes,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
	ThreadingMode RoomThreadingMode      `protobuf:"varint,2,opt,name=threading_mode,json=threadingMode,proto3,enum=chatto.core.v1.RoomThreadingMode" json:"threading_mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CallEndedEvent) Reset() {
	*x = CallEndedEvent{}
	mi := &file_chatto_core_v1_room_events_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CallEndedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_v1_room_events_proto_rawDescGZIP(), []int{14}
}
...
const file_chatto_core_v1_room_events_proto_rawDesc = "" +
	"\n" +
	" chatto/core/v1/room_events.proto\x12\x0echatto.core.v1\x1a\x1bchatto/core/v1/models.proto\"\x87\x02\n" +
	...
	"\tuniversal\x18\x06 \x01(\bR\tuniversal\x12H\n" +
	"\x0ethreading_mode\x18\a \x01(\x0e2!.chatto.core.v1.RoomThreadingModeR\rthreadingModeJ\x04\b\x01\x10\x02R\bspace_id\"q\n" +
	...
	"\x11slow_mode_seconds\x18\x02 \x01(\rR\x0fslowModeSeconds\"\x82\x01\n" +
	"\x1dRoomThreadingModeChangedEvent\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12H\n" +
	"\x0ethreading_mode\x18\x02 \x01(\x0e2!.chatto.core.v1.RoomThreadingModeR\rthreadingMode\">\n" +
...
var file_chatto_core_v1_room_events_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_chatto_core_v1_room_events_proto_goTypes = []any{
	...
	(*RoomThreadingModeChangedEvent)(nil), // 8: chatto.core.v1.RoomThreadingModeChangedEvent
	...
	(RoomThreadingMode)(0),                // 17: chatto.core.v1.RoomThreadingMode
}
var file_chatto_core_v1_room_events_proto_depIdxs = []int32{
	...
	17, // 1: chatto.core.v1.RoomCreatedEvent.threading_mode:type_name -> chatto.core.v1.RoomThreadingMode
	17, // 2: chatto.core.v1.RoomThreadingModeChangedEvent.threading_mode:type_name -> chatto.core.v1.RoomThreadingMode
	0,  // 3: chatto.core.v1.CallParticipantJoinedEvent.source:type_name -> chatto.core.v1.CallParticipantEventSource
	0,  // 4: chatto.core.v1.CallParticipantLeftEvent.source:type_name -> chatto.core.v1.CallParticipantEventSource
	0,  // 5: chatto.core.v1.CallStartedEvent.source:type_name -> chatto.core.v1.CallParticipantEventSource
	0,  // 6: chatto.core.v1.CallEndedEvent.source:type_name -> chatto.core.v1.CallParticipantEventSource
