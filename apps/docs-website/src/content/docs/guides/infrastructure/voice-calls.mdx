...
Use the **Microphone processing** panel to choose a preset:

- **No processing** (the default) disables the added filter, equaliser, and compressor.
- **Subtle processing** combines a low-cut filter, gentle tone adjustment, and light compression.
- **Strong processing** applies more tone adjustment and compression for more consistent speech volume.

The noise gate applies separately. Preset changes keep your gate threshold,
device choices, and join-muted preference. Browser echo cancellation and noise
suppression stay enabled with all three presets.
...
audio. Use the microphone test to compare the presets.
