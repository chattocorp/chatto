...
| `message.read-interactions` | Read a complete thread when the account authored its root or another account directly mentioned it there. Room membership is also required. |
