...
// ID here, and let this model own membership, message.read, and message.react
// checks.
...
// be a room member and have message.read and message.react in the target room.
...
// actor must be a room member and have message.read and message.react in the
// target room.
