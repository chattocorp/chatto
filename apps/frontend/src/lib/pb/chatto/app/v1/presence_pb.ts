...
// @generated from file chatto/app/v1/presence.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * record expire.
 *
 * @generated from enum chatto.app.v1.PresenceStatus
 */
...
proto3.util.setEnumType(PresenceStatus, "chatto.app.v1.PresenceStatus", [
...
export class ReportPresenceRequest extends Message<ReportPresenceRequest> {
  ...
  static readonly typeName = "chatto.app.v1.ReportPresenceRequest";
 ...
 *
 * @generated from message chatto.app.v1.ReportPresenceResponse
 */
export class ReportPresenceResponse extends Message<ReportPresenceResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ReportPresenceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "status", kind: "enum", T: proto3.getEnumType(PresenceStatus) },
  ]);
