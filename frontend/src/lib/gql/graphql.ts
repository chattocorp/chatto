...
export type AdminGeneralMessagesQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminGeneralMessagesQuery = { __typename?: 'Query', admin?: { __typename?: 'AdminQueries', instanceConfig: { __typename?: 'AdminInstanceConfig', isConfigured: boolean, motd?: string | null, welcomeMessage?: string | null } } | null };

export type UpdateGeneralMessagesMutationVariables = Exact<{
  input: UpdateInstanceConfigInput;
}>;


export type UpdateGeneralMessagesMutation = { __typename?: 'Mutation', admin?: { __typename?: 'AdminMutations', updateInstanceConfig: { __typename?: 'AdminInstanceConfig', isConfigured: boolean, motd?: string | null, welcomeMessage?: string | null } } | null };

export type ResetGeneralConfigMutationVariables = Exact<{ [key: string]: never; }>;


export type ResetGeneralConfigMutation = { __typename?: 'Mutation', admin?: { __typename?: 'AdminMutations', resetInstanceConfig: boolean } | null };
...
export const AdminGeneralMessagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdminGeneralMessages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"admin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"instanceConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"motd"}},{"kind":"Field","name":{"kind":"Name","value":"welcomeMessage"}}]}}]}}]}}]} as unknown as DocumentNode<AdminGeneralMessagesQuery, AdminGeneralMessagesQueryVariables>;
export const UpdateGeneralMessagesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateGeneralMessages"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateInstanceConfigInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"admin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateInstanceConfig"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isConfigured"}},{"kind":"Field","name":{"kind":"Name","value":"motd"}},{"kind":"Field","name":{"kind":"Name","value":"welcomeMessage"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateGeneralMessagesMutation, UpdateGeneralMessagesMutationVariables>;
export const ResetGeneralConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ResetGeneralConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"admin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resetInstanceConfig"}}]}}]}}]} as unknown as DocumentNode<ResetGeneralConfigMutation, ResetGeneralConfigMutationVariables>;
