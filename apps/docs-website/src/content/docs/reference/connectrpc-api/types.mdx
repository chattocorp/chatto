...
| Field | Type | Description |
| --- | --- | --- |
| `mode` | [`PresenceMode`](#chatto-api-v1-PresenceMode) | The account's saved choice, independent of current connection liveness. |
...
<a id="chatto-api-v1-PresenceMode"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `PRESENCE_MODE_UNSPECIFIED` | `0` | No choice supplied; rejected on selection. |
| `PRESENCE_MODE_ONLINE` | `1` | Show Online while at least one device refreshes liveness. |
| `PRESENCE_MODE_AWAY` | `2` | Show Away while at least one device refreshes liveness. |
| `PRESENCE_MODE_DO_NOT_DISTURB` | `3` | Suppress notification alerts on all devices until the choice changes. |
| `PRESENCE_MODE_INVISIBLE` | `4` | Public presence is indistinguishable from an offline account. |
...
| `PRESENCE_STATUS_OFFLINE` | `4` | The user has no public live presence. |
