...
const (
	...
	ViewerServiceName = "chatto.app.v1.ViewerService"
)
...
const (
	...
	ViewerServiceGetViewerProcedure = "/chatto.app.v1.ViewerService/GetViewer"
)

// ViewerServiceClient is a client for the chatto.app.v1.ViewerService service.
...
// NewViewerServiceClient constructs a client for the chatto.app.v1.ViewerService service. By
...
func NewViewerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ViewerServiceClient {
	...
	viewerServiceMethods := v1.File_chatto_app_v1_viewer_proto.Services().ByName("ViewerService").Methods()
...
// GetViewer calls chatto.app.v1.ViewerService.GetViewer.
...
// ViewerServiceHandler is an implementation of the chatto.app.v1.ViewerService service.
...
func NewViewerServiceHandler(svc ViewerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.ViewerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedViewerServiceHandler) GetViewer(context.Context, *connect.Request[v1.GetViewerRequest]) (*connect.Response[v1.GetViewerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ViewerService.GetViewer is not implemented"))
}
