...
func (c *ChattoCore) IsServerAdmin(ctx context.Context, userID string) (bool, error) {
	return c.readContentBool(ctx, func() bool {
...
func (c *ChattoCore) readContentBool(ctx context.Context, read func() bool) (bool, error) {
	return c.readContentDecision(ctx, func() (bool, error) {
		return read(), nil
	})
}

func (c *ChattoCore) readContentDecision(ctx context.Context, read func() (bool, error)) (bool, error) {
	if c.contentView == nil {
		return read()
	}
	var result bool
	err := c.ReadServerContentView(ctx, func(_ context.Context, _ uint64) error {
		var readErr error
		result, readErr = read()
		return readErr
	})
