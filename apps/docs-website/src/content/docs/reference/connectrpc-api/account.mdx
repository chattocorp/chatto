...
<a id="chatto-api-v1-AccountService-UpdatePassword"></a>
...
```http
POST /api/connect/chatto.api.v1.AccountService/UpdatePassword
```
...
<a id="chatto-api-v1-AccountService-UpdatePresence"></a>
...
```http
POST /api/connect/chatto.api.v1.AccountService/UpdatePresence
```
...
<a id="chatto-api-v1-AccountService-UpdateCustomStatus"></a>
...
```http
POST /api/connect/chatto.api.v1.AccountService/UpdateCustomStatus
```
...
<a id="chatto-api-v1-AccountService-DeleteCustomStatus"></a>
...
```http
POST /api/connect/chatto.api.v1.AccountService/DeleteCustomStatus
```
