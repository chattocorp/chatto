...
// 	protoc        (unknown)
// source: chatto/core/v1/oauth_client_events.proto
...
func (OAuthClientSource) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_v1_oauth_client_events_proto_enumTypes[0].Descriptor()
}

func (OAuthClientSource) Type() protoreflect.EnumType {
	return &file_chatto_core_v1_oauth_client_events_proto_enumTypes[0]
}
...
func (OAuthClientPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_v1_oauth_client_events_proto_enumTypes[1].Descriptor()
}

func (OAuthClientPolicy) Type() protoreflect.EnumType {
	return &file_chatto_core_v1_oauth_client_events_proto_enumTypes[1]
}
...
type OAuthClientAuthorizationRecordedEvent struct {
	...
	Source         OAuthClientSource      `protobuf:"varint,5,opt,name=source,proto3,enum=chatto.core.v1.OAuthClientSource" json:"source,omitempty"`
...
type OAuthClientPolicyChangedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClientId      string                 `protobuf:"bytes,1,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`
	Policy        OAuthClientPolicy      `protobuf:"varint,2,opt,name=policy,proto3,enum=chatto.core.v1.OAuthClientPolicy" json:"policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *OAuthClientPolicyChangedEvent) Reset() {
	*x = OAuthClientPolicyChangedEvent{}
	mi := &file_chatto_core_v1_oauth_client_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_chatto_core_v1_oauth_client_events_proto protoreflect.FileDescriptor
...
const file_chatto_core_v1_oauth_client_events_proto_rawDesc = "" +
	...
	"\x0fredirect_origin\x18\x04 \x01(\tR\x0eredirectOrigin\x129\n" +
	"\x06source\x18\x05 \x01(\x0e2!.chatto.core.v1.OAuthClientSourceR\x06source\"w\n" +
	"\x1dOAuthClientPolicyChangedEvent\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x129\n" +
	"\x06policy\x18\x02 \x01(\x0e2!.chatto.core.v1.OAuthClientPolicyR\x06policy*x\n" +
	...
	"\x1bOAUTH_CLIENT_POLICY_BLOCKED\x10\x03B\xb9\x01\n" +
	"\x12com.chatto.core.v1B\x16OauthClientEventsProtoP\x01Z1hmans.de/chatto/internal/pb/chatto/core/v1;corev1\xa2\x02\x03CCX\xaa\x02\x0eChatto.Core.V1\xca\x02\x0eChatto\\Core\\V1\xe2\x02\x1aChatto\\Core\\V1\\GPBMetadata\xea\x02\x10Chatto::Core::V1b\x06proto3"

var (
	file_chatto_core_v1_oauth_client_events_proto_rawDescOnce sync.Once
	file_chatto_core_v1_oauth_client_events_proto_rawDescData []byte
)

func file_chatto_core_v1_oauth_client_events_proto_rawDescGZIP() []byte {
	file_chatto_core_v1_oauth_client_events_proto_rawDescOnce.Do(func() {
		file_chatto_core_v1_oauth_client_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_core_v1_oauth_client_events_proto_rawDesc), len(file_chatto_core_v1_oauth_client_events_proto_rawDesc)))
	})
	return file_chatto_core_v1_oauth_client_events_proto_rawDescData
}
...
func init() { file_chatto_core_v1_oauth_client_events_proto_init() }
func file_chatto_core_v1_oauth_client_events_proto_init() {
	if File_chatto_core_v1_oauth_client_events_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chatto_core_v1_oauth_client_events_proto_rawDesc), len(file_chatto_core_v1_oauth_client_events_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chatto_core_v1_oauth_client_events_proto_goTypes,
		DependencyIndexes: file_chatto_core_v1_oauth_client_events_proto_depIdxs,
		EnumInfos:         file_chatto_core_v1_oauth_client_events_proto_enumTypes,
		MessageInfos:      file_chatto_core_v1_oauth_client_events_proto_msgTypes,
	}.Build()
	File_chatto_core_v1_oauth_client_events_proto = out.File
	file_chatto_core_v1_oauth_client_events_proto_goTypes = nil
	file_chatto_core_v1_oauth_client_events_proto_depIdxs = nil
}
