...
### chatto.personaldata.api.v1

- [PersonalDataService](/reference/connectrpc-api/personal-data/) - Authenticated portable preferences and known-server directory RPCs.
