...
| Field | Type | Description |
| --- | --- | --- |
| `protocol_capabilities` | `repeated string` | Stable protocol capability keys supported by this server. Current keys: `chatto.discovery.v1`, `chatto.auth.v1`, `chatto.api.v1`, `chatto.admin.v1`, `chatto.api.bots.v1`, `chatto.api.message-search.v1`, `chatto.realtime.v1`, and `chatto.realtime.projection.v1`. |
