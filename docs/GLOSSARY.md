...
**Invitation** — Revocable, optionally limited or expiring capability that admits one or more new accounts when a server uses invite-only account creation. See [FDR-036](fdr/FDR-036-server-invitations.md).
