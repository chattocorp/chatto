...
| Field | Type | Description |
| --- | --- | --- |
| `room` | [`RoomWithViewerState`](/reference/connectrpc-api/types/#chatto-api-v1-RoomWithViewerState) | Resolved room and viewer state. |
...
| Field | Type | Description |
| --- | --- | --- |
| `rooms` | repeated [`RoomWithViewerState`](/reference/connectrpc-api/types/#chatto-api-v1-RoomWithViewerState) | Resolved rooms in first-seen request order. |


<a id="chatto-api-v1-RoomDirectoryService-ArchiveDM"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomDirectoryService/ArchiveDM
```

<a id="chatto-api-v1-ArchiveDMRequest"></a>

#### Input: ArchiveDMRequest

Request to archive one direct-message conversation for the current user.

| Field | Type | Description |
| --- | --- | --- |
| `room_id` | `string` | Required. Direct-message room to archive. |


<a id="chatto-api-v1-ArchiveDMResponse"></a>

#### Result: ArchiveDMResponse

Updated direct-message room after archiving it for the current user.

| Field | Type | Description |
| --- | --- | --- |
| `room` | [`RoomWithViewerState`](/reference/connectrpc-api/types/#chatto-api-v1-RoomWithViewerState) | Resolved room and current viewer state. |


<a id="chatto-api-v1-RoomDirectoryService-UnarchiveDM"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomDirectoryService/UnarchiveDM
```

<a id="chatto-api-v1-UnarchiveDMRequest"></a>

#### Input: UnarchiveDMRequest
...
| Field | Type | Description |
| --- | --- | --- |
| `room_id` | `string` | Required. Direct-message room to restore. |


<a id="chatto-api-v1-UnarchiveDMResponse"></a>

#### Result: UnarchiveDMResponse
