...
| `occurrence_count` | `int32` | Total number of occurrences in this group, including those not in the bounded preview. |
...
| `unread_group_count` | `int32` | Number of unread groups targeting this room. |
...
| `NOTIFICATION_DELIVERY_INTENSITY_BADGE` | `2` | Matching activity appears in the notification list without interruptive delivery. |
| `NOTIFICATION_DELIVERY_INTENSITY_ALERT` | `3` | Matching activity appears in the notification list and may trigger sound or push. |
