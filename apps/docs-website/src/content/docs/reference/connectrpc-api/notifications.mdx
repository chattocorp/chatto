...
| Field | Type | Description |
| --- | --- | --- |
| `item` | [`NotificationItem`](/reference/connectrpc-api/types/#chatto-api-v1-NotificationItem) | Requested notification. |
| `server_name` | `string` | Current server display name for non-DM location labels. |
...
| Field | Type | Description |
| --- | --- | --- |
| `items` | repeated [`NotificationItem`](/reference/connectrpc-api/types/#chatto-api-v1-NotificationItem) | Found notifications. The server preserves first-seen request order and de-duplicates repeated IDs. |
| `server_name` | `string` | Current server display name for non-DM location labels. |
