...
// @generated from file chatto/app/v1/notification_preferences.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum chatto.app.v1.NotificationLevel
 */
...
proto3.util.setEnumType(NotificationLevel, "chatto.app.v1.NotificationLevel", [
 ...
 *
 * @generated from message chatto.app.v1.GetRoomNotificationPreferenceResponse
 */
export class GetRoomNotificationPreferenceResponse extends Message<GetRoomNotificationPreferenceResponse> {
  ...
  static readonly typeName = "chatto.app.v1.GetRoomNotificationPreferenceResponse";
 ...
 *
 * @generated from message chatto.app.v1.SetRoomNotificationLevelResponse
 */
export class SetRoomNotificationLevelResponse extends Message<SetRoomNotificationLevelResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetRoomNotificationLevelResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
    { no: 2, name: "effective_level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.GetServerNotificationPreferenceResponse
 */
export class GetServerNotificationPreferenceResponse extends Message<GetServerNotificationPreferenceResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetServerNotificationPreferenceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
    { no: 2, name: "effective_level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.SetServerNotificationLevelResponse
 */
export class SetServerNotificationLevelResponse extends Message<SetServerNotificationLevelResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetServerNotificationLevelResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
    { no: 2, name: "effective_level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.GetServerNotificationPreferenceRequest
 */
export class GetServerNotificationPreferenceRequest extends Message<GetServerNotificationPreferenceRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetServerNotificationPreferenceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message chatto.app.v1.SetServerNotificationLevelRequest
 */
export class SetServerNotificationLevelRequest extends Message<SetServerNotificationLevelRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetServerNotificationLevelRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "level", kind: "enum", T: proto3.getEnumType(NotificationLevel) },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.GetRoomNotificationPreferenceRequest
 */
export class GetRoomNotificationPreferenceRequest extends Message<GetRoomNotificationPreferenceRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.GetRoomNotificationPreferenceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.SetRoomNotificationLevelRequest
 */
export class SetRoomNotificationLevelRequest extends Message<SetRoomNotificationLevelRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.SetRoomNotificationLevelRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
