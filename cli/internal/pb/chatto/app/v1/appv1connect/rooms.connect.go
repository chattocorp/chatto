...
const (
	...
	RoomServiceName = "chatto.app.v1.RoomService"
)
...
// NewRoomServiceClient constructs a client for the chatto.app.v1.RoomService service. By default,
...
func NewRoomServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RoomServiceClient {
	...
	roomServiceMethods := v1.File_chatto_app_v1_rooms_proto.Services().ByName("RoomService").Methods()
...
// CreateRoom calls chatto.app.v1.RoomService.CreateRoom.
...
// UpdateRoom calls chatto.app.v1.RoomService.UpdateRoom.
...
// ArchiveRoom calls chatto.app.v1.RoomService.ArchiveRoom.
...
// UnarchiveRoom calls chatto.app.v1.RoomService.UnarchiveRoom.
...
// SetRoomUniversal calls chatto.app.v1.RoomService.SetRoomUniversal.
...
// JoinRoom calls chatto.app.v1.RoomService.JoinRoom.
...
// StartDM calls chatto.app.v1.RoomService.StartDM.
...
// LeaveRoom calls chatto.app.v1.RoomService.LeaveRoom.
...
// ListRoomBans calls chatto.app.v1.RoomService.ListRoomBans.
...
// BanRoomMember calls chatto.app.v1.RoomService.BanRoomMember.
...
// UnbanRoomMember calls chatto.app.v1.RoomService.UnbanRoomMember.
...
// RoomServiceHandler is an implementation of the chatto.app.v1.RoomService service.
...
func NewRoomServiceHandler(svc RoomServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.RoomService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRoomServiceHandler) CreateRoom(context.Context, *connect.Request[v1.CreateRoomRequest]) (*connect.Response[v1.CreateRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.CreateRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) UpdateRoom(context.Context, *connect.Request[v1.UpdateRoomRequest]) (*connect.Response[v1.UpdateRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.UpdateRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) ArchiveRoom(context.Context, *connect.Request[v1.ArchiveRoomRequest]) (*connect.Response[v1.ArchiveRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.ArchiveRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) UnarchiveRoom(context.Context, *connect.Request[v1.UnarchiveRoomRequest]) (*connect.Response[v1.UnarchiveRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.UnarchiveRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) SetRoomUniversal(context.Context, *connect.Request[v1.SetRoomUniversalRequest]) (*connect.Response[v1.SetRoomUniversalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.SetRoomUniversal is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) JoinRoom(context.Context, *connect.Request[v1.JoinRoomRequest]) (*connect.Response[v1.JoinRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.JoinRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) StartDM(context.Context, *connect.Request[v1.StartDMRequest]) (*connect.Response[v1.StartDMResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.StartDM is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) LeaveRoom(context.Context, *connect.Request[v1.LeaveRoomRequest]) (*connect.Response[v1.LeaveRoomResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.LeaveRoom is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) ListRoomBans(context.Context, *connect.Request[v1.ListRoomBansRequest]) (*connect.Response[v1.ListRoomBansResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.ListRoomBans is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) BanRoomMember(context.Context, *connect.Request[v1.BanRoomMemberRequest]) (*connect.Response[v1.BanRoomMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.BanRoomMember is not implemented"))
}
...
func (UnimplementedRoomServiceHandler) UnbanRoomMember(context.Context, *connect.Request[v1.UnbanRoomMemberRequest]) (*connect.Response[v1.UnbanRoomMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoomService.UnbanRoomMember is not implemented"))
}
