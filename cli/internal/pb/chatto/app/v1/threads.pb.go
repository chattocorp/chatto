...
// 	protoc        (unknown)
// source: chatto/app/v1/threads.proto
...
func (x *FollowThreadRequest) Reset() {
	*x = FollowThreadRequest{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[0]
...
func (*FollowThreadRequest) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{0}
}
...
func (x *FollowThreadResponse) Reset() {
	*x = FollowThreadResponse{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FollowThreadResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{1}
}
...
func (x *UnfollowThreadRequest) Reset() {
	*x = UnfollowThreadRequest{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnfollowThreadRequest) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{2}
}
...
func (x *UnfollowThreadResponse) Reset() {
	*x = UnfollowThreadResponse{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnfollowThreadResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{3}
}
...
func (x *FollowedThread) Reset() {
	*x = FollowedThread{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FollowedThread) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{4}
}
...
func (x *ListFollowedThreadsRequest) Reset() {
	*x = ListFollowedThreadsRequest{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListFollowedThreadsRequest) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{5}
}
...
func (x *ListFollowedThreadsResponse) Reset() {
	*x = ListFollowedThreadsResponse{}
	mi := &file_chatto_app_v1_threads_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListFollowedThreadsResponse) Descriptor() ([]byte, []int) {
	return file_chatto_app_v1_threads_proto_rawDescGZIP(), []int{6}
}
...
var File_chatto_app_v1_threads_proto protoreflect.FileDescriptor

const file_chatto_app_v1_threads_proto_rawDesc = "" +
	"\n" +
	"\x1bchatto/app/v1/threads.proto\x12\rchatto.app.v1\x1a\x1bbuf/validate/validate.proto\x1a!chatto/app/v1/room_timeline.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"q\n" +
	...
	"\froot_message\x18\x04 \x01(\v2 .chatto.app.v1.RoomTimelineEventR\vrootMessage\x12\x1f\n" +
	...
	"\athreads\x18\x01 \x03(\v2\x1d.chatto.app.v1.FollowedThreadR\athreads\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\x12\x19\n" +
	"\bhas_more\x18\x03 \x01(\bR\ahasMore\x12?\n" +
	"\bincludes\x18\x04 \x01(\v2#.chatto.app.v1.RoomTimelineIncludesR\bincludes2\xb5\x02\n" +
	"\rThreadService\x12l\n" +
	"\x13ListFollowedThreads\x12).chatto.app.v1.ListFollowedThreadsRequest\x1a*.chatto.app.v1.ListFollowedThreadsResponse\x12W\n" +
	"\fFollowThread\x12\".chatto.app.v1.FollowThreadRequest\x1a#.chatto.app.v1.FollowThreadResponse\x12]\n" +
	"\x0eUnfollowThread\x12$.chatto.app.v1.UnfollowThreadRequest\x1a%.chatto.app.v1.UnfollowThreadResponseB\xa8\x01\n" +
	"\x11com.chatto.app.v1B\fThreadsProtoP\x01Z/hmans.de/chatto/internal/pb/chatto/app/v1;appv1\xa2\x02\x03CAX\xaa\x02\rChatto.App.V1\xca\x02\rChatto\\App\\V1\xe2\x02\x19Chatto\\App\\V1\\GPBMetadata\xea\x02\x0fChatto::App::V1b\x06proto3"

var (
	file_chatto_app_v1_threads_proto_rawDescOnce sync.Once
	file_chatto_app_v1_threads_proto_rawDescData []byte
)

func file_chatto_app_v1_threads_proto_rawDescGZIP() []byte {
	file_chatto_app_v1_threads_proto_rawDescOnce.Do(func() {
		file_chatto_app_v1_threads_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_app_v1_threads_proto_rawDesc), len(file_chatto_app_v1_threads_proto_rawDesc)))
	})
	return file_chatto_app_v1_threads_proto_rawDescData
}

var file_chatto_app_v1_threads_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_chatto_app_v1_threads_proto_goTypes = []any{
	(*FollowThreadRequest)(nil),         // 0: chatto.app.v1.FollowThreadRequest
	(*FollowThreadResponse)(nil),        // 1: chatto.app.v1.FollowThreadResponse
	(*UnfollowThreadRequest)(nil),       // 2: chatto.app.v1.UnfollowThreadRequest
	(*UnfollowThreadResponse)(nil),      // 3: chatto.app.v1.UnfollowThreadResponse
	(*FollowedThread)(nil),              // 4: chatto.app.v1.FollowedThread
	(*ListFollowedThreadsRequest)(nil),  // 5: chatto.app.v1.ListFollowedThreadsRequest
	(*ListFollowedThreadsResponse)(nil), // 6: chatto.app.v1.ListFollowedThreadsResponse
	(*RoomTimelineEvent)(nil),           // 7: chatto.app.v1.RoomTimelineEvent
	(*timestamppb.Timestamp)(nil),       // 8: google.protobuf.Timestamp
	(*RoomTimelineIncludes)(nil),        // 9: chatto.app.v1.RoomTimelineIncludes
}
var file_chatto_app_v1_threads_proto_depIdxs = []int32{
	7, // 0: chatto.app.v1.FollowedThread.root_message:type_name -> chatto.app.v1.RoomTimelineEvent
	8, // 1: chatto.app.v1.FollowedThread.last_reply_at:type_name -> google.protobuf.Timestamp
	4, // 2: chatto.app.v1.ListFollowedThreadsResponse.threads:type_name -> chatto.app.v1.FollowedThread
	9, // 3: chatto.app.v1.ListFollowedThreadsResponse.includes:type_name -> chatto.app.v1.RoomTimelineIncludes
	5, // 4: chatto.app.v1.ThreadService.ListFollowedThreads:input_type -> chatto.app.v1.ListFollowedThreadsRequest
	0, // 5: chatto.app.v1.ThreadService.FollowThread:input_type -> chatto.app.v1.FollowThreadRequest
	2, // 6: chatto.app.v1.ThreadService.UnfollowThread:input_type -> chatto.app.v1.UnfollowThreadRequest
	6, // 7: chatto.app.v1.ThreadService.ListFollowedThreads:output_type -> chatto.app.v1.ListFollowedThreadsResponse
	1, // 8: chatto.app.v1.ThreadService.FollowThread:output_type -> chatto.app.v1.FollowThreadResponse
	3, // 9: chatto.app.v1.ThreadService.UnfollowThread:output_type -> chatto.app.v1.UnfollowThreadResponse
...
func init() { file_chatto_app_v1_threads_proto_init() }
func file_chatto_app_v1_threads_proto_init() {
	if File_chatto_app_v1_threads_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chatto_app_v1_threads_proto_rawDesc), len(file_chatto_app_v1_threads_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_chatto_app_v1_threads_proto_goTypes,
		DependencyIndexes: file_chatto_app_v1_threads_proto_depIdxs,
		MessageInfos:      file_chatto_app_v1_threads_proto_msgTypes,
	}.Build()
	File_chatto_app_v1_threads_proto = out.File
	file_chatto_app_v1_threads_proto_goTypes = nil
	file_chatto_app_v1_threads_proto_depIdxs = nil
}
