...
Open **Client Preferences → Message editor** from the gear in the Application Header and choose:
...
Open **Client Preferences → Send messages with** from the gear in the Application Header and choose:
