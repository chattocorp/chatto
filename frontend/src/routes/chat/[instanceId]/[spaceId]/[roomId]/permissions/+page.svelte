...
<div class="flex min-h-0 min-w-0 flex-1 flex-col">
  <PaneHeader
    ...
    subtitle="What you're allowed to do in this room, and which role decided each call"
    showMobileNav
  />

  <div class="flex flex-col gap-6 overflow-y-auto p-6">
    {#if !userId || !spaceId || !roomId}
      <div class="text-muted">Loading...</div>
    {:else}
      <PermissionInspectorPanel {userId} {spaceId} {roomId} />
    {/if}
  </div>
</div>
