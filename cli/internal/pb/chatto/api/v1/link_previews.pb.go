...
func (x *FetchLinkPreviewResponse) Reset() {
	*x = FetchLinkPreviewResponse{}
	mi := &file_chatto_api_v1_link_previews_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FetchLinkPreviewResponse) Descriptor() ([]byte, []int) {
	return file_chatto_api_v1_link_previews_proto_rawDescGZIP(), []int{7}
}
...
const file_chatto_api_v1_link_previews_proto_rawDesc = "" +
	"\n" +
	"!chatto/api/v1/link_previews.proto\x12\rchatto.api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"j\n" +
...
var file_chatto_api_v1_link_previews_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_chatto_api_v1_link_previews_proto_goTypes = []any{
	...
	(*SocialPostPreview)(nil),        // 3: chatto.api.v1.SocialPostPreview
	(*SocialPostAuthor)(nil),         // 4: chatto.api.v1.SocialPostAuthor
	(*SocialPostImage)(nil),          // 5: chatto.api.v1.SocialPostImage
	(*SocialPostExternalLink)(nil),   // 6: chatto.api.v1.SocialPostExternalLink
	(*FetchLinkPreviewResponse)(nil), // 7: chatto.api.v1.FetchLinkPreviewResponse
	(*timestamppb.Timestamp)(nil),    // 8: google.protobuf.Timestamp
}
var file_chatto_api_v1_link_previews_proto_depIdxs = []int32{
	3, // 0: chatto.api.v1.LinkPreview.social_post:type_name -> chatto.api.v1.SocialPostPreview
	4, // 1: chatto.api.v1.SocialPostPreview.author:type_name -> chatto.api.v1.SocialPostAuthor
	8, // 2: chatto.api.v1.SocialPostPreview.published_at:type_name -> google.protobuf.Timestamp
	5, // 3: chatto.api.v1.SocialPostPreview.images:type_name -> chatto.api.v1.SocialPostImage
	6, // 4: chatto.api.v1.SocialPostPreview.external_link:type_name -> chatto.api.v1.SocialPostExternalLink
	3, // 5: chatto.api.v1.SocialPostPreview.quoted_post:type_name -> chatto.api.v1.SocialPostPreview
	2, // 6: chatto.api.v1.FetchLinkPreviewResponse.preview:type_name -> chatto.api.v1.LinkPreview
	1, // 7: chatto.api.v1.FetchLinkPreviewResponse.imported_attachment:type_name -> chatto.api.v1.ImportedLinkAttachment
...
func file_chatto_api_v1_link_previews_proto_init() {
	...
	file_chatto_api_v1_link_previews_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
