...
const (
	...
	ReactionServiceName = "chatto.app.v1.ReactionService"
)
...
const (
	...
	// AddReaction RPC.
	ReactionServiceAddReactionProcedure = "/chatto.app.v1.ReactionService/AddReaction"
	// ReactionServiceRemoveReactionProcedure is the fully-qualified name of the ReactionService's
	// RemoveReaction RPC.
	ReactionServiceRemoveReactionProcedure = "/chatto.app.v1.ReactionService/RemoveReaction"
)

// ReactionServiceClient is a client for the chatto.app.v1.ReactionService service.
...
// NewReactionServiceClient constructs a client for the chatto.app.v1.ReactionService service. By
...
func NewReactionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ReactionServiceClient {
	...
	reactionServiceMethods := v1.File_chatto_app_v1_reactions_proto.Services().ByName("ReactionService").Methods()
...
// AddReaction calls chatto.app.v1.ReactionService.AddReaction.
...
// RemoveReaction calls chatto.app.v1.ReactionService.RemoveReaction.
...
// ReactionServiceHandler is an implementation of the chatto.app.v1.ReactionService service.
...
func NewReactionServiceHandler(svc ReactionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.ReactionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedReactionServiceHandler) AddReaction(context.Context, *connect.Request[v1.AddReactionRequest]) (*connect.Response[v1.AddReactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ReactionService.AddReaction is not implemented"))
}
...
func (UnimplementedReactionServiceHandler) RemoveReaction(context.Context, *connect.Request[v1.RemoveReactionRequest]) (*connect.Response[v1.RemoveReactionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.ReactionService.RemoveReaction is not implemented"))
}
