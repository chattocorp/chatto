...
// @generated from file chatto/app/v1/threads.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.app.v1.FollowThreadRequest
 */
export class FollowThreadRequest extends Message<FollowThreadRequest> {
  ...
  static readonly typeName = "chatto.app.v1.FollowThreadRequest";
 ...
 *
 * @generated from message chatto.app.v1.FollowThreadResponse
 */
export class FollowThreadResponse extends Message<FollowThreadResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.FollowThreadResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.UnfollowThreadRequest
 */
export class UnfollowThreadRequest extends Message<UnfollowThreadRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.UnfollowThreadRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "thread_root_event_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.UnfollowThreadResponse
 */
export class UnfollowThreadResponse extends Message<UnfollowThreadResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.UnfollowThreadResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "following", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
 ...
 *
 * @generated from message chatto.app.v1.FollowedThread
 */
export class FollowedThread extends Message<FollowedThread> {
   ...
   *
   * @generated from field: chatto.app.v1.RoomTimelineEvent root_message = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.FollowedThread";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message chatto.app.v1.ListFollowedThreadsRequest
 */
export class ListFollowedThreadsRequest extends Message<ListFollowedThreadsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListFollowedThreadsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.ListFollowedThreadsResponse
 */
export class ListFollowedThreadsResponse extends Message<ListFollowedThreadsResponse> {
   ...
   *
   * @generated from field: repeated chatto.app.v1.FollowedThread threads = 1;
   */
   ...
   *
   * @generated from field: chatto.app.v1.RoomTimelineIncludes includes = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListFollowedThreadsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
