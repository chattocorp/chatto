...
// 	protoc        (unknown)
// source: chatto/core/evt/v1/rbac_events.proto
...
func (RbacPermissionScopeKind) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_evt_v1_rbac_events_proto_enumTypes[0].Descriptor()
}

func (RbacPermissionScopeKind) Type() protoreflect.EnumType {
	return &file_chatto_core_evt_v1_rbac_events_proto_enumTypes[0]
}
...
func (RbacPermissionScopeKind) EnumDescriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{0}
}
...
func (RbacPermissionSubjectKind) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_evt_v1_rbac_events_proto_enumTypes[1].Descriptor()
}

func (RbacPermissionSubjectKind) Type() protoreflect.EnumType {
	return &file_chatto_core_evt_v1_rbac_events_proto_enumTypes[1]
}
...
func (RbacPermissionSubjectKind) EnumDescriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{1}
}
...
func (x *RbacRoleCreatedEvent) Reset() {
	*x = RbacRoleCreatedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[0]
...
func (x *RbacRoleDisplayNameChangedEvent) Reset() {
	*x = RbacRoleDisplayNameChangedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *RbacRoleDescriptionChangedEvent) Reset() {
	*x = RbacRoleDescriptionChangedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RbacRoleDescriptionChangedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{2}
}
...
func (x *RbacRolePingableChangedEvent) Reset() {
	*x = RbacRolePingableChangedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RbacRolePingableChangedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{3}
}
...
func (x *RbacRoleDeletedEvent) Reset() {
	*x = RbacRoleDeletedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RbacRoleDeletedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{4}
}
...
func (x *RbacRolesReorderedEvent) Reset() {
	*x = RbacRolesReorderedEvent{}
	mi := &file_chatto_core_evt_v1_rbac_events_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RbacRolesReorderedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP(), []int{5}
}
...
type RbacPermissionSubject struct {
	state protoimpl.MessageState    `protogen:"open.v1"`
	Kind  RbacPermissionSubjectKind `protobuf:"varint,1,opt,name=kind,proto3,enum=chatto.core.evt.v1.RbacPermissionSubjectKind" json:"kind,omitempty"`
...
var File_chatto_core_evt_v1_rbac_events_proto protoreflect.FileDescriptor
...
const file_chatto_core_evt_v1_rbac_events_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1b\n" +
	"\trole_name\x18\x02 \x01(\tR\broleName\"f\n" +
	"\x13RbacPermissionScope\x12?\n" +
	"\x04kind\x18\x01 \x01(\x0e2+.chatto.core.evt.v1.RbacPermissionScopeKindR\x04kind\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"j\n" +
	"\x15RbacPermissionSubject\x12A\n" +
	"\x04kind\x18\x01 \x01(\x0e2-.chatto.core.evt.v1.RbacPermissionSubjectKindR\x04kind\x12\x0e\n" +
	...
	"\asubject\x18\x05 \x01(\v2).chatto.core.evt.v1.RbacPermissionSubjectR\asubjectJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\blocation\"\xd5\x01\n" +
	"\x19RbacPermissionDeniedEvent\x12\x1e\n" +
	"\n" +
	"permission\x18\x03 \x01(\tR\n" +
	"permission\x12=\n" +
	"\x05scope\x18\x04 \x01(\v2'.chatto.core.evt.v1.RbacPermissionScopeR\x05scope\x12C\n" +
	"\asubject\x18\x05 \x01(\v2).chatto.core.evt.v1.RbacPermissionSubjectR\asubjectJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\blocation\"\xd6\x01\n" +
	...
	"!RBAC_PERMISSION_SUBJECT_KIND_USER\x10\x02B\xca\x01\n" +
	"\x16com.chatto.core.evt.v1B\x0fRbacEventsProtoP\x01Z4hmans.de/chatto/internal/pb/chatto/core/evt/v1;evtv1\xa2\x02\x03CCE\xaa\x02\x12Chatto.Core.Evt.V1\xca\x02\x12Chatto\\Core\\Evt\\V1\xe2\x02\x1eChatto\\Core\\Evt\\V1\\GPBMetadata\xea\x02\x15Chatto::Core::Evt::V1b\x06proto3"

var (
	file_chatto_core_evt_v1_rbac_events_proto_rawDescOnce sync.Once
	file_chatto_core_evt_v1_rbac_events_proto_rawDescData []byte
)

func file_chatto_core_evt_v1_rbac_events_proto_rawDescGZIP() []byte {
	file_chatto_core_evt_v1_rbac_events_proto_rawDescOnce.Do(func() {
		file_chatto_core_evt_v1_rbac_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_core_evt_v1_rbac_events_proto_rawDesc), len(file_chatto_core_evt_v1_rbac_events_proto_rawDesc)))
	})
	return file_chatto_core_evt_v1_rbac_events_proto_rawDescData
}
...
var file_chatto_core_evt_v1_rbac_events_proto_goTypes = []any{
	...
	(*RbacRoleCreatedEvent)(nil),            // 2: chatto.core.evt.v1.RbacRoleCreatedEvent
	(*RbacRoleDisplayNameChangedEvent)(nil), // 3: chatto.core.evt.v1.RbacRoleDisplayNameChangedEvent
	(*RbacRoleDescriptionChangedEvent)(nil), // 4: chatto.core.evt.v1.RbacRoleDescriptionChangedEvent
...
func init() { file_chatto_core_evt_v1_rbac_events_proto_init() }
func file_chatto_core_evt_v1_rbac_events_proto_init() {
	if File_chatto_core_evt_v1_rbac_events_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_chatto_core_evt_v1_rbac_events_proto_goTypes,
		DependencyIndexes: file_chatto_core_evt_v1_rbac_events_proto_depIdxs,
		EnumInfos:         file_chatto_core_evt_v1_rbac_events_proto_enumTypes,
		MessageInfos:      file_chatto_core_evt_v1_rbac_events_proto_msgTypes,
	}.Build()
	File_chatto_core_evt_v1_rbac_events_proto = out.File
	file_chatto_core_evt_v1_rbac_events_proto_goTypes = nil
	file_chatto_core_evt_v1_rbac_events_proto_depIdxs = nil
}
