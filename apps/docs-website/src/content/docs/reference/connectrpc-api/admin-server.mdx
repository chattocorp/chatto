...
| `profile` | [`chatto.api.v1.ServerProfile`](/reference/connectrpc-api/types/#chatto-api-v1-ServerProfile) | Effective server profile and branding. |
...
| Field | Type | Description |
| --- | --- | --- |
| `profile` | [`chatto.api.v1.ServerProfile`](/reference/connectrpc-api/types/#chatto-api-v1-ServerProfile) | Updated server profile and branding. |
