...
On browsers that support Trusted Types, the policy requires Trusted Types for
script injection sinks. It allows only the named policies that the bundled
SvelteKit, Svelte, markdown, media, and editor code uses. Browsers without
Trusted Types still enforce the other CSP directives.
