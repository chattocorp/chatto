...
const msg_personal_data_settings_title = (): LocalizedString => messages().personal_data_settings_title(empty());
const msg_personal_data_settings_subtitle = (): LocalizedString => messages().personal_data_settings_subtitle(empty());
const msg_personal_data_settings_save_failed = (): LocalizedString => messages().personal_data_settings_save_failed(empty());
const msg_personal_data_settings_home_title = (): LocalizedString => messages().personal_data_settings_home_title(empty());
const msg_personal_data_settings_home_description = (): LocalizedString => messages().personal_data_settings_home_description(empty());
const msg_personal_data_settings_home_add_server_first = (): LocalizedString => messages().personal_data_settings_home_add_server_first(empty());
const msg_personal_data_settings_home_choose_prompt = (): LocalizedString => messages().personal_data_settings_home_choose_prompt(empty());
const msg_personal_data_settings_sync_local = (): LocalizedString => messages().personal_data_settings_sync_local(empty());
const msg_personal_data_settings_sync_loading = (): LocalizedString => messages().personal_data_settings_sync_loading(empty());
const msg_personal_data_settings_sync_synced = (): LocalizedString => messages().personal_data_settings_sync_synced(empty());
const msg_personal_data_settings_sync_unavailable = (): LocalizedString => messages().personal_data_settings_sync_unavailable(empty());
const msg_personal_data_settings_sync_error = (): LocalizedString => messages().personal_data_settings_sync_error(empty());
...
export { msg_personal_data_settings_title as 'personal_data.settings.title' };
export { msg_personal_data_settings_subtitle as 'personal_data.settings.subtitle' };
export { msg_personal_data_settings_save_failed as 'personal_data.settings.save_failed' };
export { msg_personal_data_settings_home_title as 'personal_data.settings.home.title' };
export { msg_personal_data_settings_home_description as 'personal_data.settings.home.description' };
export { msg_personal_data_settings_home_add_server_first as 'personal_data.settings.home.add_server_first' };
export { msg_personal_data_settings_home_choose_prompt as 'personal_data.settings.home.choose_prompt' };
export { msg_personal_data_settings_sync_local as 'personal_data.settings.sync.local' };
export { msg_personal_data_settings_sync_loading as 'personal_data.settings.sync.loading' };
export { msg_personal_data_settings_sync_synced as 'personal_data.settings.sync.synced' };
export { msg_personal_data_settings_sync_unavailable as 'personal_data.settings.sync.unavailable' };
export { msg_personal_data_settings_sync_error as 'personal_data.settings.sync.error' };
