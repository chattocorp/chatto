...
Under **Microphone processing**, adjust **Voice Quality** while running the
microphone test. Move toward **AWESOME** for stronger processing, or select
**Normal** to turn it off.
