...
// 	protoc        (unknown)
// source: chatto/core/evt/v1/thread_events.proto
...
func (ThreadFollowSource) Descriptor() protoreflect.EnumDescriptor {
	return file_chatto_core_evt_v1_thread_events_proto_enumTypes[0].Descriptor()
}

func (ThreadFollowSource) Type() protoreflect.EnumType {
	return &file_chatto_core_evt_v1_thread_events_proto_enumTypes[0]
}
...
func (ThreadFollowSource) EnumDescriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_thread_events_proto_rawDescGZIP(), []int{0}
}
...
func (x *ThreadCreatedEvent) Reset() {
	*x = ThreadCreatedEvent{}
	mi := &file_chatto_core_evt_v1_thread_events_proto_msgTypes[0]
...
type ThreadFollowedEvent struct {
	...
	Source        ThreadFollowSource `protobuf:"varint,4,opt,name=source,proto3,enum=chatto.core.evt.v1.ThreadFollowSource" json:"source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ThreadFollowedEvent) Reset() {
	*x = ThreadFollowedEvent{}
	mi := &file_chatto_core_evt_v1_thread_events_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ThreadFollowedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_thread_events_proto_rawDescGZIP(), []int{1}
}
...
func (x *ThreadUnfollowedEvent) Reset() {
	*x = ThreadUnfollowedEvent{}
	mi := &file_chatto_core_evt_v1_thread_events_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ThreadUnfollowedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_core_evt_v1_thread_events_proto_rawDescGZIP(), []int{2}
}
...
var File_chatto_core_evt_v1_thread_events_proto protoreflect.FileDescriptor
...
const file_chatto_core_evt_v1_thread_events_proto_rawDesc = "" +
	...
	"(THREAD_FOLLOW_SOURCE_ROOT_AUTHOR_CREATED\x10\x05B\xcc\x01\n" +
	"\x16com.chatto.core.evt.v1B\x11ThreadEventsProtoP\x01Z4hmans.de/chatto/internal/pb/chatto/core/evt/v1;evtv1\xa2\x02\x03CCE\xaa\x02\x12Chatto.Core.Evt.V1\xca\x02\x12Chatto\\Core\\Evt\\V1\xe2\x02\x1eChatto\\Core\\Evt\\V1\\GPBMetadata\xea\x02\x15Chatto::Core::Evt::V1b\x06proto3"

var (
	file_chatto_core_evt_v1_thread_events_proto_rawDescOnce sync.Once
	file_chatto_core_evt_v1_thread_events_proto_rawDescData []byte
)

func file_chatto_core_evt_v1_thread_events_proto_rawDescGZIP() []byte {
	file_chatto_core_evt_v1_thread_events_proto_rawDescOnce.Do(func() {
		file_chatto_core_evt_v1_thread_events_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chatto_core_evt_v1_thread_events_proto_rawDesc), len(file_chatto_core_evt_v1_thread_events_proto_rawDesc)))
	})
	return file_chatto_core_evt_v1_thread_events_proto_rawDescData
}

var file_chatto_core_evt_v1_thread_events_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_chatto_core_evt_v1_thread_events_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_chatto_core_evt_v1_thread_events_proto_goTypes = []any{
	(ThreadFollowSource)(0),       // 0: chatto.core.evt.v1.ThreadFollowSource
	(*ThreadCreatedEvent)(nil),    // 1: chatto.core.evt.v1.ThreadCreatedEvent
	(*ThreadFollowedEvent)(nil),   // 2: chatto.core.evt.v1.ThreadFollowedEvent
	(*ThreadUnfollowedEvent)(nil), // 3: chatto.core.evt.v1.ThreadUnfollowedEvent
}
var file_chatto_core_evt_v1_thread_events_proto_depIdxs = []int32{
	0, // 0: chatto.core.evt.v1.ThreadFollowedEvent.source:type_name -> chatto.core.evt.v1.ThreadFollowSource
...
func init() { file_chatto_core_evt_v1_thread_events_proto_init() }
func file_chatto_core_evt_v1_thread_events_proto_init() {
	if File_chatto_core_evt_v1_thread_events_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chatto_core_evt_v1_thread_events_proto_rawDesc), len(file_chatto_core_evt_v1_thread_events_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chatto_core_evt_v1_thread_events_proto_goTypes,
		DependencyIndexes: file_chatto_core_evt_v1_thread_events_proto_depIdxs,
		EnumInfos:         file_chatto_core_evt_v1_thread_events_proto_enumTypes,
		MessageInfos:      file_chatto_core_evt_v1_thread_events_proto_msgTypes,
	}.Build()
	File_chatto_core_evt_v1_thread_events_proto = out.File
	file_chatto_core_evt_v1_thread_events_proto_goTypes = nil
	file_chatto_core_evt_v1_thread_events_proto_depIdxs = nil
}
