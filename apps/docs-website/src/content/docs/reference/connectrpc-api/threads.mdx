...
| `includes` | [`RoomTimelineIncludes`](/reference/connectrpc-api/types/#chatto-api-v1-RoomTimelineIncludes) | Related entities needed to render this feed page without per-thread hydration. Singular resource reads and mutations do not use includes maps. |
