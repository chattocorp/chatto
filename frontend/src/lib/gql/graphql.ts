...
export type Room = {
  ...
  /**
   * Number of pending notifications for the current user in this room.
   * Returns 0 if the user is not a member or has no pending notifications.
   */
  viewerUnreadNotificationCount: Scalars['Int']['output'];
  /**
