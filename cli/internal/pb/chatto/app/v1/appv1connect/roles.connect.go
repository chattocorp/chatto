...
const (
	...
	RoleServiceName = "chatto.app.v1.RoleService"
)
...
const (
	...
	RoleServiceListRolesProcedure = "/chatto.app.v1.RoleService/ListRoles"
	// RoleServiceGetRoleProcedure is the fully-qualified name of the RoleService's GetRole RPC.
	RoleServiceGetRoleProcedure = "/chatto.app.v1.RoleService/GetRole"
	// RoleServiceCreateRoleProcedure is the fully-qualified name of the RoleService's CreateRole RPC.
	RoleServiceCreateRoleProcedure = "/chatto.app.v1.RoleService/CreateRole"
	// RoleServiceUpdateRoleProcedure is the fully-qualified name of the RoleService's UpdateRole RPC.
	RoleServiceUpdateRoleProcedure = "/chatto.app.v1.RoleService/UpdateRole"
	// RoleServiceDeleteRoleProcedure is the fully-qualified name of the RoleService's DeleteRole RPC.
	RoleServiceDeleteRoleProcedure = "/chatto.app.v1.RoleService/DeleteRole"
	// RoleServiceReorderRolesProcedure is the fully-qualified name of the RoleService's ReorderRoles
	// RPC.
	RoleServiceReorderRolesProcedure = "/chatto.app.v1.RoleService/ReorderRoles"
)

// RoleServiceClient is a client for the chatto.app.v1.RoleService service.
...
// NewRoleServiceClient constructs a client for the chatto.app.v1.RoleService service. By default,
...
func NewRoleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RoleServiceClient {
	...
	roleServiceMethods := v1.File_chatto_app_v1_roles_proto.Services().ByName("RoleService").Methods()
...
// ListRoles calls chatto.app.v1.RoleService.ListRoles.
...
// GetRole calls chatto.app.v1.RoleService.GetRole.
...
// CreateRole calls chatto.app.v1.RoleService.CreateRole.
...
// UpdateRole calls chatto.app.v1.RoleService.UpdateRole.
...
// DeleteRole calls chatto.app.v1.RoleService.DeleteRole.
...
// ReorderRoles calls chatto.app.v1.RoleService.ReorderRoles.
...
// RoleServiceHandler is an implementation of the chatto.app.v1.RoleService service.
...
func NewRoleServiceHandler(svc RoleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatto.app.v1.RoleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRoleServiceHandler) ListRoles(context.Context, *connect.Request[v1.ListRolesRequest]) (*connect.Response[v1.ListRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.ListRoles is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) GetRole(context.Context, *connect.Request[v1.GetRoleRequest]) (*connect.Response[v1.GetRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.GetRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) CreateRole(context.Context, *connect.Request[v1.CreateRoleRequest]) (*connect.Response[v1.CreateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.CreateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) UpdateRole(context.Context, *connect.Request[v1.UpdateRoleRequest]) (*connect.Response[v1.UpdateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.UpdateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) DeleteRole(context.Context, *connect.Request[v1.DeleteRoleRequest]) (*connect.Response[v1.DeleteRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.DeleteRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) ReorderRoles(context.Context, *connect.Request[v1.ReorderRolesRequest]) (*connect.Response[v1.ReorderRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatto.app.v1.RoleService.ReorderRoles is not implemented"))
}
