...
// @generated from file chatto/app/v1/member_directory.proto (package chatto.app.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message chatto.app.v1.DirectoryMember
 */
export class DirectoryMember extends Message<DirectoryMember> {
  ...
  static readonly typeName = "chatto.app.v1.DirectoryMember";
 ...
 *
 * @generated from message chatto.app.v1.ListServerMembersRequest
 */
export class ListServerMembersRequest extends Message<ListServerMembersRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListServerMembersRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Server member page.
 *
 * @generated from message chatto.app.v1.ListServerMembersResponse
 */
export class ListServerMembersResponse extends Message<ListServerMembersResponse> {
  /**
   * Members in the requested page.
   *
   * @generated from field: repeated chatto.app.v1.DirectoryMember members = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListServerMembersResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message chatto.app.v1.ListRoomMembersRequest
 */
export class ListRoomMembersRequest extends Message<ListRoomMembersRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListRoomMembersRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Room member page.
 *
 * @generated from message chatto.app.v1.ListRoomMembersResponse
 */
export class ListRoomMembersResponse extends Message<ListRoomMembersResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "chatto.app.v1.ListRoomMembersResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "members", kind: "message", T: DirectoryMember, repeated: true },
    { no: 2, name: "total_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "has_more", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
