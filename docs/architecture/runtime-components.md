...
| `PresenceModel`                  | [`presence_model.go`](../../cli/internal/core/presence_model.go), [`presence_hub.go`](../../cli/internal/core/presence_hub.go)                                    | Revision-checked private choices in EVT, live heartbeat writes, and a per-process projection/watcher deriving public presence and counts |
