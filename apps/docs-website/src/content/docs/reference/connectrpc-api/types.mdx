...
| `incoming_webhook` | [`BotIncomingWebhook`](#chatto-api-v1-BotIncomingWebhook) | Incoming webhook credential metadata. Absent when the webhook is disabled. |
...
| Field | Type | Description |
| --- | --- | --- |
| `created_at` | `google.protobuf.Timestamp` | Time the incoming webhook credential was enabled. |
| `rotated_at` | `optional google.protobuf.Timestamp` | Most recent credential rotation time, when it has been rotated. |
