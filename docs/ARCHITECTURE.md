...
| `/api/connect/chatto.admin.v1.AdminMemberService/SetUserPassword`                              | `AdminMemberService`             | `SetUserPassword`               | Authenticated; requires `role.assign`; self-target is rejected.                                                                                                     | Set another user's password as an admin action and revoke their runtime credentials.                                                                                                                   |
