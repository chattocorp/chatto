...
| `/api/connect/chatto.admin.v1.AdminMemberService/AssignRole`                                   | `AdminMemberService`             | `AssignRole`                   | Authenticated; requires `role.assign`. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.                                      | Assign a server role to a user.                                                                                                                                                                        |
| `/api/connect/chatto.admin.v1.AdminMemberService/RevokeRole`                                   | `AdminMemberService`             | `RevokeRole`                   | Authenticated; requires `role.assign`; cannot revoke caller's own owner/admin role. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system. | Revoke a server role from a user.                                                                                                                                                                      |
...
| `/api/connect/chatto.admin.v1.AdminMemberService/DeleteUser`                                   | `AdminMemberService`             | `DeleteUser`                   | Authenticated; requires account-deletion authority for the target. Dedicated Admin API listener also accepts operator tokens from allowed CIDRs as system.          | Permanently delete a user through the normal account-deletion model.                                                                                                                                    |
