...
| **Encouraged** | **Reply** opens the thread with attribution, while **Reply in room** remains in the expanded menu. The reply icons keep their normal order, and creating a thread with a new root stays opt-in. |
