...
| `bot_owner_user_id` | `optional string` | Human account that owns this bot. Absent for human or deleted accounts. This public identity reference does not grant bot management access. |
