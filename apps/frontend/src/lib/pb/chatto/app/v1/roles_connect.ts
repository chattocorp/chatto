 ...
 *
 * @generated from service chatto.app.v1.RoleService
 */
export const RoleService = {
  typeName: "chatto.app.v1.RoleService",
  methods: {
    /**
     * Lists the server role catalog. Requires an authenticated user.
     *
     * @generated from rpc chatto.app.v1.RoleService.ListRoles
     */
    listRoles: {
      name: "ListRoles",
      I: ListRolesRequest,
     ...
     *
     * @generated from rpc chatto.app.v1.RoleService.GetRole
     */
    getRole: {
      name: "GetRole",
      I: GetRoleRequest,
     ...
     *
     * @generated from rpc chatto.app.v1.RoleService.CreateRole
     */
    createRole: {
      name: "CreateRole",
      I: CreateRoleRequest,
     ...
     *
     * @generated from rpc chatto.app.v1.RoleService.UpdateRole
     */
    updateRole: {
      name: "UpdateRole",
      I: UpdateRoleRequest,
     ...
     *
     * @generated from rpc chatto.app.v1.RoleService.DeleteRole
     */
    deleteRole: {
      name: "DeleteRole",
      I: DeleteRoleRequest,
     ...
     *
     * @generated from rpc chatto.app.v1.RoleService.ReorderRoles
     */
    reorderRoles: {
      name: "ReorderRoles",
