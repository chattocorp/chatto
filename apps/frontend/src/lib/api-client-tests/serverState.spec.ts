  ...
  it('loads authenticated server state and maps optional and int64 fields', async () => {
    ...
    mocks.getViewer.mockResolvedValue({
      viewerPermissions: {
        permissions: [
          ...
          { permission: 'room.manage.bans', granted: true },
          { permission: 'message.post', granted: true },
          { permission: 'message.post.replies', granted: true },
          ...
          { permission: 'role.manage.assignments', granted: true },
          { permission: 'user.read', granted: true },
    ...
    expect(state).toEqual({
      ...
      viewerPermissions: {
        ...
        'message.post': true,
        'message.post.replies': true,
        'message.react': true,
        'role.manage.assignments': true,
        'role.manage': true,
        'room.manage.bans': true,
        'room.create': true,
        'room.join': true,
        'room.list': true,
        'room.manage': false,
