...
- Generate the realtime event catalogue from the runtime public-event
  catalogue and protobuf field-surface options. Document only client-visible
  `chatto.core.evt.v1.Event` variants and fields. Do not expose the complete
  core storage schema as a public reference.
