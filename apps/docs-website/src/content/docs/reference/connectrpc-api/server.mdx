...
<a id="chatto-api-v1-ServerService-GetServerProfile"></a>
...
```http
POST /api/connect/chatto.api.v1.ServerService/GetServerProfile
```

<a id="chatto-api-v1-GetServerProfileRequest"></a>
...
<a id="chatto-api-v1-GetServerProfileResponse"></a>

#### Result: GetServerProfileResponse

Authenticated public server profile response.

| Field | Type | Description |
| --- | --- | --- |
| `profile` | [`ServerPublicProfile`](/reference/connectrpc-api/types/#chatto-api-v1-ServerPublicProfile) | Current public server profile. |
