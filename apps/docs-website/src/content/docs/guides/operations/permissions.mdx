...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **everyone**  | Every authenticated user has this role. Fresh servers grant normal member defaults here: room discovery/joining, message reading, posting, thread posting, attaching files, reactions, echoing thread replies, and deleting your own account.                                            |
...
| **Direct messages** | Global overrides for message actions in all DMs.          |
...
All `message.*` permissions can be configured at Direct messages scope. No
