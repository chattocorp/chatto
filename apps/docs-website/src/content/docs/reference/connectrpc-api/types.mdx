...
| Field | Type | Description |
| --- | --- | --- |
| `author_edit_window` | `google.protobuf.Duration` | Maximum message age for author edits. Zero disables author edits. Users with message.manage remain unrestricted by this window. Maximum: 30 days. |
...
| Field | Type | Description |
| --- | --- | --- |
| `layer` | `chatto.api.v1.RoomConfig` | Sparse configuration stored directly at the scope. An absent field inherits from the next broader scope. |
