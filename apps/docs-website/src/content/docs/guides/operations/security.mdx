...
<LinkCard
  ...
  href="/guides/planning/permissions/"
...
Owners are effective-owner overrides: they are allowed for every normal RBAC permission, and their permissions are virtual rather than stored as editable grants. Roles still have display order, but Chatto does not use role position as an authorization rank. See the [permissions guide](/guides/planning/permissions/) for the full resolution model.
...
See [Encryption at Rest and Data Erasure](/guides/planning/privacy-erasure/) for the exact field-level encryption coverage and threat model.
...
<LinkCard
  ...
  href="/guides/planning/privacy-erasure/"
...
<CardGrid>
  ...
  <LinkCard title="Encryption at Rest and Data Erasure" href="/guides/planning/privacy-erasure/" description="How backups and retained keys affect encrypted data and crypto-shredding." />
</CardGrid>
