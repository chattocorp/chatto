...
<ReleaseFeatureCard title="Version-aware compatibility">
  ...
  boundaries to show useful upgrade guidance.
</ReleaseFeatureCard>
...
<ReleaseFeatureCard title="Advertise friendly Chatto servers">
  ...
  add a public testimonial to each recommendation. The directory shows these
  source-labelled testimonials in a tapestry layout. A listing is a
