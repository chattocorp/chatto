...
and can contain at most 500 Unicode characters. Blank lines start new
paragraphs. You can use emphasis, strong emphasis, and inline code. Chatto does
not render links, headings, lists, tables, images, or source HTML. A server can
